  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
		...
		<li class="<?php if($_GET['p']=="newbonpenghubung" or $_GET['p']=="newbonpenghubung"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="Newbonpenghubung"><i class="fa fa-calendar"></i> <span>New bon penghubung</span></a></li>                
		<li class="<?php if($_GET['p']=="Label-QCF"){echo"active";} ?>"><a href="LabelQCF"><i class="fa fa-file-text-o"></i> <span>Label QCF</span></a></li>
              ...
              <ul class="treeview-menu">
                ...
                <?php if($_SESSION['lvl_id']=="LEADERTQ"){?>
				  ...
				  <!-- jika user marketing hidden -->
                  <?php if($_SESSION['usrid'] != "marketing"){ ?>
				  <li class="<?php if($_GET['p']=="TestingDelay"){echo"active";} ?>"><a href="TestingDelay"><i class="fa fa-list-alt text-aqua"></i> <span>Testing Delay</span></a></li>
				  <!-- end jika username marketing hidden-->
                  <?php } ?>
                  ...
                  <li class="<?php if($_GET['p']=="Report-New"){echo"active";} ?>"><a href="ReportNew"><i class="fa fa-file-text-o text-aqua"></i> <span>Report Adidas</span></a></li>
				  <li class="<?php if($_GET['p']=="Report-Mills"){echo"active";} ?>"><a href="ReportMills"><i class="fa fa-file-text-o text-aqua"></i> <span>Report Mills</span></a></li>
				  ...
				  <li class="<?php if($_GET['p']=="Report-MIZUNO" OR $_GET['p']=="Report-Mizuno"){echo"active";} ?>"><a href="ReportMizuno"><i class="fa fa-file-text-o text-aqua"></i> <span>Report Mizuno</span></a></li>
		    ...
		    <li class="treeview <?php if($_GET['p']=="Kain-Masuk-Lab" or $_GET['p']=="Testing-Lab" or $_GET['p']=="Result-Lab" or $_GET['p']=="EditTQ-Lab" or $_GET['p']=="Master-Data-Lab"){echo"active";}?>">
              ...
              <ul class="treeview-menu">
				 <!-- jika user marketing hidden -->
                  <?php if($_SESSION['usrid'] != "marketing"){ ?> 
       		      <li class="<?php if($_GET['p']=="Kain-Masuk-Lab"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="KainInLab"><i class="fa fa-calendar text-aqua"></i> <span>Kain Masuk</span></a></li>		   
		   	      <li class="<?php if($_GET['p']=="Testing-Lab"){echo"active";} ?>"><a href="TestingLab"><i class="fa fa-file-text text-aqua"></i> <span>Testing</span></a></li>
				  <!-- end jika username marketing hidden-->
                  <?php } ?>
		   	      <li class="<?php if($_GET['p']=="Result-Lab"){echo"active";} ?>"><a href="ResultLab"><i class="fa fa-check-circle-o text-aqua"></i> <span>Result</span></a></li>				  
                  <?php if($_SESSION['lvl_id']=="LEADERTQ"){?>
				  <!-- jika user marketing hidden -->
                  <?php if($_SESSION['usrid'] != "marketing"){ ?>
                  <li class="<?php if($_GET['p']=="EditTQ-Lab"){echo"active";} ?>"><a href="EditTQLab"><i class="fa fa-edit text-aqua"></i> <span>Edit Testing</span></a></li>
				  <!-- end jika username marketing hidden-->
                  <?php } ?>				  
                  <?php } ?>
				  <li class="<?php if($_GET['p']=="Master-Data-Lab"){echo"active";} ?>"><a href="MasterDataLab"><i class="fa fa-database text-aqua"></i> <span>Master Data</span></a></li>  
              </ul>
            </li>
			<!-- jika user marketing hidden -->
             <?php if($_SESSION['usrid'] != "marketing"){ ?>
             <!--Yulianto-->
             <?php $sub_menu_fl = 'FL'; ?>
            <li class="treeview <?php if($_GET['p']=="xxx" or $_GET['p']=="xxx" ){echo"active";}?>">
              ...
              <ul class="treeview-menu">
       		      <li class="<?php if($_GET['p']=="xxx"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="KainInNewFL"><i class="fa fa-calendar text-aqua"></i> <span>Kain Masuk <?=$sub_menu_fl?></span></a></li>		   
		   	        <li class="<?php if($_GET['p']=="xxx"){echo"active";} ?>"><a href="TestingNewFL"><i class="fa fa-file-text text-aqua"></i> <span>Testing <?=$sub_menu_fl?></span></a></li>
		   	       <?php if($_SESSION['lvl_id']=="LEADERTQ"){?>
                  <li class="<?php if($_GET['p']=="xxx"){echo"active";} ?>"><a href="EditTQNewFL"><i class="fa fa-edit text-aqua"></i> <span>Edit Testing <?=$sub_menu_fl?></span></a></li>        
                  <li class="<?php if($_GET['p']=="xxx"){echo"active";} ?>"><a href="StatusTQNewFL"><i class="fa fa-list-alt text-aqua"></i> <span>Status <?=$sub_menu_fl?></span></a></li>
                  <li class="<?php if($_GET['p']=="xxx"){echo"active";} ?>"><a href="SummaryTQNewFL"><i class="fa fa-list text-aqua"></i> <span>Summary Test Quality</span></a></li>
                  <li class="<?php if($_GET['p']=="xxx"){echo"active";} ?>"><a href="ReportNewFL"><i class="fa fa-file-text-o text-aqua"></i> <span>Report <?=$sub_menu_fl?></span></a></li> 
                  <li class="<?php if($_GET['p']=="xxx"){echo"active";} ?>"><a href="MasterDataNewFL"><i class="fa fa-cube text-aqua"></i> <span>Master Data <?=$sub_menu_fl?></span></a></li>                
		   ...
		   <!-- end jika username marketing hidden-->
              ...
              <ul class="treeview-menu">
				...
				<li class="<?php if($_GET['p']=="Lap-KPE-Status"){echo"active";} ?>"><a href="LapKPEStatus"><i class="fa fa-calendar"></i> <span>Status KPE</span></a></li>  
          ...
          <?php if($_SESSION['lvl_id']=="AFTERSALES"){  ?>
            <li class="treeview <?php if($_GET['p']=="Input-Detail-Disposisi-Now" or $_GET['p']=="Disposisi-Now"){echo"active";}?>">
              ...
              <ul class="treeview-menu">
				...
				<li class="<?php if($_GET['p']=="Lap-GantiKainDisposisi"){echo"active";} ?>"><a href="LapGantiKainDisposisi"><i class="fa fa-exchange"></i> <span>Lap Ganti Kain Disposisi</span></a></li>  
              </ul>
            </li>
            <?php } ?>
          ...
          <?php if($_SESSION['lvl_id']=="SPVQC" OR $_SESSION['lvl_id']=="AFTERSALES"){  ?>
            <li class="treeview <?php if($_GET['p']=="Data-Pengiriman-Now" or $_GET['p']=="Persediaan-Now" or $_GET['p']=="Aftersales-Now"){echo"active";}?>">
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['p']=="Aftersales-Now"){echo"active";} ?>"><a href="AftersalesNOW"><i class="fa fa-bar-chart"></i> <span>Aftersales NOW</span></a></li>	
       		      <li class="<?php if($_GET['p']=="Data-Pengiriman-Now"){echo"active";} ?>"><a href="DataPengirimanNOW"><i class="fa fa-info"></i> <span>Data Pengiriman NOW</span></a></li>		
                <li class="<?php if($_GET['p']=="Persediaan-Now"){echo"active";} ?>"><a href="PersediaanNOW"><i class="fa fa-warning"></i> <span>Persediaan Stok NOW</span></a></li>			 	 
              </ul>
            </li>
            <li class="treeview <?php if($_GET['p']=="Stiker-Custom-New"){echo"active";}?>">
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['p']=="Stiker-Custom-New"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="StikerCustomNew"><i class="fa fa-file-text"></i> <span>Stiker Custom</span></a></li>
              </ul>
            </li>
          <?php } ?>
              ...
              <ul class="treeview-menu">
                ...
                <?php } ?> 
				  <li class="<?php if($_GET['p']=="Status-NCP-New"){echo"active";} ?>"><a href="StatusNCPNew"><i class="fa fa-area-chart text-navy"></i> <span>Status NCP</span> </a></li>
              </ul>
            </li>
		    <li class="treeview <?php if($_GET['p']=="Lap-NCP" or $_GET['p']=="Register-NCP" or $_GET['p']=="Lap-NCP-Lama" or $_GET['p']=="Lap-NCP-Memo" or $_GET['p']=="Lap-NSP" or $_GET['p']=="Lap-NCP-NSP" or $_GET['p']=="Lap-5Besar-NCP" or $_GET['p']=="Lap-NCP-CanDis" or $_GET['p']=="Grafik-NCP"){echo"active";}?>">
              <a href="#"><i class="fa fa-file-o text-blue"></i> <span>Reports NCP</span>
		       ...
		       <ul class="treeview-menu">
				<li class="<?php if($_GET['p']=="Lap-NCP-Now"){echo"active";} ?>"><a href="LapNCPNow"><i class="fa fa-circle-o text-navy"></i> <span>Laporan NCP</span></a></li>
				<li class="<?php if($_GET['p']=="Lap-NCP-Bulan-Now"){echo"active";} ?>"><a href="LapNCPBulanNow"><i class="fa fa-circle-o text-blue"></i> <span>Laporan NCP Bulanan</span></a></li>   
                <li class="<?php if($_GET['p']=="Lap-Pencapaian-Now"){echo"active";} ?>"><a href="LapPencapaianNow"><i class="fa fa-circle-o text-warning"></i> <span>Laporan Pencapaian</span></a></li>	  
          		<li class="<?php if($_GET['p']=="Lap-5Besar-NCP-Now"){echo"active";} ?>"><a href="Lap5BesarNCPNow"><i class="fa fa-circle-o text-orange"></i> <span>Laporan 5 Besar NCP</span></a></li> 
          		<li class="<?php if($_GET['p']=="Lap-3Besar-NCP-Now"){echo"active";} ?>"><a href="Lap3BesarNCPNow"><i class="fa fa-circle-o text-teal"></i> <span>Laporan 3 Besar NCP</span></a></li> 
          		<li class="<?php if($_GET['p']=="Lap-NCP-CanDis-Now"){echo"active";} ?>"><a href="LapNCPCanDisNow"><i class="fa fa-circle-o text-green"></i> <span>Lap NCP Cancel/Disposisi</span></a></li>
		  		<li class="<?php if($_GET['p']=="Lap-Kesesuaian-Colorist"){echo"active";} ?>"><a href="LapSesuaiColorist"><i class="fa fa-circle-o text-red"></i> <span>Lap Kesesuaian Colorist</span></a></li>	  
		  		<li class="<?php if($_GET['p']=="Grafik-NCP-Now"){echo"active";} ?>"><a href="GrafikNCPNow"><i class="fa fa-circle-o text-purple"></i> <span>Grafik NCP</span></a></li>	  
              </ul>	
            </li>   
		      <?php } ?>  
		      <?php if($_SESSION['lvl_id']=="INSPEKSI"){  ?>
		        <li class="treeview <?php if($_GET['p']=="Schedule" or $_GET['p']=="Status-Mesin" or $_GET['p']=="Inspeksi-Kain" or $_GET['p']=="Line-News" or $_GET['p']=="Grafik-QCF" or $_GET['p']=="Lap-Inspektor" or $_GET['p']=="Lap-Inspeksi" or $_GET['p']=="Status-Mesin-Gabung" or $_GET['p']=="SummaryInspeksi" or $_GET['p']=="Input-Lap-Shading" or $_GET['p']=="Lihat-Data-Shading" or $_GET['p']=="Summary-Inspeksi" or $_GET['p']=="Summary-Inspect-Packing" or $_GET['p']=="Inspect-Report-Now"){echo"active";}?>">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php if($_GET['p']=="Inspect-Report-Now"){echo"active";} ?>"><a href="InspectionReportNOW"><i class="fa fa-circle-o text-green"></i> <span>Inspection Report NOW</span></a></li>
          ...
          <?php if($_SESSION['lvl_id']=="PACKING" OR $_SESSION['lvl_id']=="NCP"){  ?>  
            ...
            <li class="treeview <?php if($_GET['p']=="Input-Lap-Krah-New" or $_GET['p']=="Lihat-Data-Lap-Krah-New" or $_GET['p']=="Form-Schedule-Krah" or $_GET['p']=="Schedule-Krah" or $_GET['p']=="Lap-Data-Krah-New"){echo"active";}?>">
              ...
              <ul class="treeview-menu">
                ...
                <li class="<?php if($_GET['p']=="Schedule-Krah"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="ScheduleKrah"><i class="fa fa-file-text"></i> <span>Schedule Krah</span></a></li>
                <li class="<?php if($_GET['p']=="Lap-Data-Krah-New"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="LapDataKrahNew"><i class="fa fa-file-text"></i> <span>Lap Krah </span><span class="pull-right-container">
                  <small class="label pull-right bg-green blink_me">new</small>
                </span></a></li>
				<li class="<?php if($_GET['p']=="Mutasi-BS"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="MutasiBS"><i class="fa fa-file-text"></i> <span>Mutasi BS</span></a></li> 
				<li class="<?= ($_GET['p'] == "Lap-Personil") ? "active" : ""; ?>
					<?= ($_SESSION['akses'] == "biasa") ? "hidden" : ""; ?>">
					<a href="LapPersonil"><i class="fa fa-file-text"></i> <span>Laporan Personil</span></a></li>  
              </ul>
            </li>
            ...
            <li class="treeview <?php if($_GET['p']=="Input-Lap-InspekMeja-New" or $_GET['p']=="Lihat-Data-InspekMeja"){echo"active";}?>">
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['p']=="Input-Lap-InspekMeja-New" or $_GET['p']=="Lihat-Data-InspekMeja"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="LapInspekMejaNew"><i class="fa fa-file-text"></i> <span>Lap Inspek Meja</span></a></li>
              </ul>
            </li>
            ...
            <li class="treeview <?php if($_GET['p']=="Input-Lap-Beda-Roll" or $_GET['p']=="Lihat-Data-Beda-Roll"){echo"active";}?>">
            ...
            <ul class="treeview-menu">
            <li class="<?php if($_GET['p']=="Input-Lap-Beda-Roll" or $_GET['p']=="Lihat-Data-Beda-Roll"){echo"active";} ?> <?php if($_SESSION['akses']=="biasa"){echo "hidden";} ?>"><a href="InputLapBedaRoll"><i class="fa fa-gear text-teal"></i> <span>Lap Beda Roll</span></a></li>	  
                </ul>
              </li>
...
$.fn.editable.defaults.mode = 'inline';
    $(document).ready(function() {
	  ...
	  $('.jns_limbah').editable({
        ...
        showbuttons : false,
        disabled : false,
        source:[{value: "", text: ""}, {value: "BS BESAR", text: "BS BESAR"}, {value: "BS KECIL", text: "BS KECIL"}]
      });
	  $('.diserah').editable({
        type: 'text',        
      ...
      $('.sts_warna').editable({
        ...
        disabled : false,
         source:[
			{value: "", text: ""},
			{value: "OK", text: "OK"},
			{value: "TOLAK BASAH BEDA WARNA",text: "TOLAK BASAH BEDA WARNA"},
			{value: "TOLAK BASAH LUNTUR",text: "TOLAK BASAH LUNTUR"},
			{value: "TOLAK BASAH BEDA WARNA + LUNTUR",text: "TOLAK BASAH BEDA WARNA + LUNTUR"},
      ...
      $('.colorist_qcf').editable({
        ...
        disabled : false,
        showbuttons : false,
        source:[{value: "", text: ""}, {value: "AGUNG", text: "AGUNG"}, {value: "AGUS", text: "AGUS"}, {value: "ANDI", text: "ANDI"}, {value: "DEWI", text: "DEWI"}, {value: "FERRY", text: "FERRY"}, {value: "PRIMA", text: "PRIMA"}, {value: "RUDI", text: "RUDI"}]
      });
      $('.review_qcf_dye').editable({
        ...
        disabled : false,
        showbuttons : false,
        source:[{value: "", text: ""}, {value: "AGUNG", text: "AGUNG"}, {value: "DEWI", text: "DEWI"}, {value: "FERRY", text: "FERRY"}]
      });
...
$(document).on('click', '.detail_kirim_kain', function (e) {
  ...
  var c = $(this).attr("lotcode");
    $.ajax({
       ...
       type: "GET",
       data : {id: m, nowarna: a, project: b, lotcode: c,},
       success: function (ajaxData){
         $("#DetailKirimKain").html(ajaxData);
         $("#DetailKirimKain").modal('show',{backdrop: 'true'});
       }
     });
      });
  ...
  var m = $(this).attr("id");
    $.ajax({
       ...
       success: function (ajaxData){
         ...
         $("#DetailRollShading").modal('show',{backdrop: 'true'});
       }
     });
      });
  ...
  var m = $(this).attr("id");
    $.ajax({
       ...
       success: function (ajaxData){
         ...
         $("#DetailBedaRoll").modal('show',{backdrop: 'true'});
       }
     });
      });
