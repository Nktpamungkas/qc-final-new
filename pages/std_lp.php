            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Light and Perspiration</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder=""><?php if($r['stat_lp']=="RANDOM"){echo $rcekR['rlight_pers_colorchange'];}else if($r['stat_lp']=="DISPOSISI"){echo $rcekD['dlight_pers_colorchange'];}else{echo $r['light_pers_colorchange'];}?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="lp" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="lp" class="form-control" placeholder="">3-4 Color Change</textarea>
                                </div>
                        </div>
		        </div>
