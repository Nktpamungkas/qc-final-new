...
$qry=mysqli_query($con,"SELECT a.*, a.id AS idkk, b.* 
From tbl_tq_nokk a 
INNER JOIN tbl_master_test b ON a.no_test=b.no_testmaster 
left join tbl_tq_nokk_demand c on (a.id = c.id_nokk)
WHERE IF(a.`nodemand_new` != '', a.`nodemand_new`, a.`nodemand`) =  '$nodemand' or c.nodemand = '$nodemand' ORDER BY a.id DESC LIMIT 1");
    ...
    <div class="box-body"> 
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="nodemand" type="text" class="form-control" id="nodemand" placeholder="No Demand" value="<?php echo $_GET['nodemand'];?>" onchange="window.location='SummaryTQNokkNew-'+this.value" required>
                </div>		
				<div class="col-sm-5">
                  ...
                  <div class="box-body">
                    <table id="example1" class="table table-bordered table-hover table-striped" width="100%"> 
                        ...
                        <tbody>
                                ...
                                WHERE nodemand='$nodemand' order by a.id desc limit 1 ";
                            ...
                            <?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){?>
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nodemand'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){echo "SHRINKAGE";} ?></a></td>
                                <td align="center" >
                            ...
                            <?php } ?>
							       ...
							       <?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){?>
                            <tr>
                                <td align="left" ><a href="Testing2New-<?php echo $row['nodemand'];?>-<?php echo $row['no_test'];?>" class="btn btn-info btn-xs <?php if($_SESSION['akses']=='biasa'){ echo "disabled"; }?>"><?php if(in_array("FABRIC WEIGHT & SHRINKAGE & SPIRALITY",$detail)){echo "SPIRALITY";} ?></a></td>
                                <td align="center" >
...
if($_POST['status_save']=="save" and $_POST['status']==""){
  echo "<script>swal({
    ...
    if (result.value) {
     ...
     window.location.href='SummaryTQNokkNew-$nodemand'; 
    }
  });</script>";
