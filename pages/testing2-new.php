<?php 
	...
	echo "<script>
			window.location.href='TestingNewNoTes-$no_test'; 
	</script>";
?>
<style>
...
$notes=$_GET['no_test'];
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE IF(`nodemand_new` != '', `nodemand_new`, `nodemand`) =  '$nodemand' AND no_test='$notes'");
  		...
  		<div class="box-body"> 
	 		<div class="col-md-6">
      			<div class="form-group">
					...
					<!-- <?php if($cek>0){?><a href="#" class="btn btn-info btn-xs posisi_kktq" id="<?php echo $_GET['nokk']; ?>">Posisi Terakhir</a><?php }?> -->
                </div>
