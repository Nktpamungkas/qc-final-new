...
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE nodemand='$nodemand' ORDER BY id DESC LIMIT 1");
                  ...
                  <label for="nodemand" class="col-sm-3 control-label">No Demand</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='TestingNew-'+this.value" value="<?php echo $_GET['nodemand'];?>" placeholder="No Demand" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
					</div>
					<!-- <?php if($_GET['nodemand']!=""){?><a href="#" class="btn btn-info btn-xs posisi_kktq" id="<?php echo $_GET['nodemand']; ?>">Posisi Terakhir</a><?php }?> -->
            </div>
			<div class="form-group">
