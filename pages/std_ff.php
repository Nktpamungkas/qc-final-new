            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Fibre/Fuzz</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder=""><?php if($r['stat_ff']=="RANDOM"){echo $rcekR['rfibre_transfer'];}else if($r['stat_ff']=="DISPOSISI"){echo $rcekD['dfibre_transfer'];}else{echo $r['fibre_transfer'];}?> &#13;&#10;Grade= <?php if($r['stat_ff']=="RANDOM"){echo $rcekR['rfibre_grade'];}else if($r['stat_ff']=="DISPOSISI"){echo $rcekD['dfibre_grade'];}else{echo $r['fibre_grade'];}?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="ff" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="ff" class="form-control" placeholder="">Fibre Transfer: Slight &#13;&#10;Color Staining: > 4</textarea>
                                </div>
                        </div>
		        </div>
