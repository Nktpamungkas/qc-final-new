        ...
        <div class="col-xs-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="box-footer">
                        <a href="pages/cetak/excel_5besar_masalah_item_bon_penghubung.php?awal=<?php echo $_POST['awal']; ?>&akhir=<?php echo $_POST['akhir']; ?>&langganan=<?php echo $_POST['langganan']; ?>&kirim=<?php echo $TotalKirim; ?>"
