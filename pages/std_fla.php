            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Flammability</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <input name="hasil_test" type="text" class="form-control" value="<?php if($r['stat_fla']=="RANDOM"){echo $rcekR['rflamability'];}else if($r['stat_fla']=="DISPOSISI"){echo $rcekD['dflamability'];}else{echo $r['flamability'];}?>" placeholder="" readonly>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="fla" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="fla" class="form-control" placeholder="">Class 1</textarea>
                                </div>
                        </div>
		        </div>
