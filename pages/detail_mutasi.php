...
echo "<td width=10%><div align='center'>Yard </div></td>";
echo "<td width=10%><div align='center'>Grade </div></td>";
echo "<td width=10%><div align='center'>No Inspek</div></td>";
...
$no=1;
    while($row2=mysqli_fetch_array($sql)){	
        echo "<tr>";
	      ...
	      echo "<td width=10% valign=top align=center>"; echo number_format($row2['net_wight'],'2','.',','); echo "</td>";
        ...
        echo "<td width=10% valign=top align=center>$row2[rolexp]</td>";
