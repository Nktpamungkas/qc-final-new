            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard PH</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder=""><?php if($r['stat_ph']=="RANDOM"){echo $rcekR['rph'];}else if($r['stat_ph']=="DISPOSISI"){echo $rcekD['dph'];}else{echo $r['ph'];}?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="ph" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="ph" class="form-control" placeholder="">4.0-7.5</textarea>
                                </div>
                        </div>
		        </div>
