            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Evaporation Rate</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder="" rows="3"><?php if($r['dry1']!="" or $rcekR['rdry1']!=""){?>Original= <?php if($r['stat_dry']=="RANDOM"){echo $rcekR['rdry1'];}else if($r['stat_dry']=="DISPOSISI"){echo $rcekD['ddry1'];}else{echo $r['dry1'];}?><?php } ?>
                                    <?php if($r['dryaf1']!="" or $rcekR['rdryaf1']!=""){?>&#13;&#10;After Wash= <?php if($r['stat_dry']=="RANDOM"){echo $rcekR['rdryaf1'];}else if($r['stat_dry']=="DISPOSISI"){echo $rcekD['ddryaf1'];}else{echo $r['dryaf1'];}?><?php } ?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="dry" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="dry" class="form-control" placeholder="" rows="5">Depends On RDY Label &#13;&#10;&ge; 0.2</textarea>
                                </div>
                        </div>
		        </div>
