        ...
        border-right:0px #000000 solid;"><table width="100%" border="0" class="table-list1"> 
          <tr>
            <td align="center" style="border-top:0px #000000 solid; 
              border-bottom:0px #000000 solid;
              border-left:0px #000000 solid; 
              border-right:0px #000000 solid;"><strong><font size="+1">LAPORAN BEDA ROLL DEPARTEMEN QCF</font><br />
          </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <thead>
          ...
          <?php
            ...
            if($Awal!="" or $Langganan!="" or $Item!="" or $Hanger!="" or $Warna!="" or $PO!="" or $Order!=""){
              $qry1=mysqli_query($con,"SELECT * FROM tbl_lap_beda_roll WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d' ) BETWEEN '$start_date' AND '$stop_date' $lgn $noitem $nohanger $wn $nopo $noorder $shft ORDER BY id ASC");
            }else{
              $qry1=mysqli_query($con,"SELECT * FROM tbl_lap_beda_roll WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d' ) BETWEEN '$start_date' AND '$stop_date' $lgn $noitem $nohanger $wn $nopo $noorder $shft ORDER BY id ASC");
            }
