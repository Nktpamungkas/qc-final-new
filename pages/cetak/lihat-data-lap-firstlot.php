        ...
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          ...
          <?php
            ...
            if($Awal!="" or $Order!="" or $Item!="" or $Langganan!="" or $Nokk!="" or $Warna!="" or $Approve_Awal!=""){
              $qry1=mysql_query("SELECT * FROM tbl_firstlot WHERE nokk LIKE '%$Nokk%' AND no_order LIKE '%$Order%' AND po LIKE '%$PO%' AND no_item LIKE '%$Item%' AND langganan LIKE '%$Langganan%' AND warna LIKE '%$Warna%' $Where $appr ORDER BY id ASC");
            }else{
              $qry1=mysql_query("SELECT * FROM tbl_firstlot WHERE nokk LIKE '%$Nokk%' AND no_order LIKE '$Order' AND po LIKE '$PO' AND no_item LIKE '$Item' AND langganan LIKE '$Langganan' AND warna LIKE '$Warna' $Where $appr ORDER BY id ASC");
            }
