...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            <?php
                $query=mysqli_query($con,"SELECT * FROM tbl_tq_randomtest WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND (rbs_instron!='' OR rbs_tru!='' OR rbs_mullen!='') GROUP BY no_item ");
