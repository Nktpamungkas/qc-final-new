...
<table width="100%" border="1">
  ...
  $sql .=" ORDER BY a.tgl_masuk ASC, a.no_test ASC";
    ...
    <tr>
	  ...
	  <td><?php if($r['apperss_pf1']!='')  { echo "'".$r['apperss_pf1'];}?></td>
      <td><?php if($r['apperss_pf2']!='')  { echo "'".$r['apperss_pf2'];}?></td>
      <td><?php if($r['apperss_pf3']!='') { echo "'".$r['apperss_pf3'];}?></td>
      <td><?php if($r['apperss_pf4']!='')  { echo "'".$r['apperss_pf4'];}?></td>
      <td><?php if($r['apperss_pb1']!='') { echo "'".$r['apperss_pb1'];}?></td>
      <td><?php if($r['apperss_pb2']!='') { echo "'".$r['apperss_pb2'];}?></td>
      <td><?php if($r['apperss_pb3']!='')  { echo "'".$r['apperss_pb3'];}?></td>
      <td><?php if($r['apperss_pb4']!='')  { echo "'".$r['apperss_pb4'];}?></td>
	  
	  
      <td><?php echo $r['apperss_ch1'];?></td>
      <td><?php echo $r['apperss_ch2'];?></td>
      <td><?php echo $r['apperss_ch3'];?></td>
      <td><?php echo $r['apperss_ch4'];?></td>
	  
	  <td><?php  if($r['apperss_cc1']!='')     { echo "'".$r['apperss_cc1'];}?></td>
      <td><?php  if($r['apperss_cc2']!='')    { echo "'".$r['apperss_cc2'];}?></td>
      <td><?php  if($r['apperss_cc3']!='')    { echo "'".$r['apperss_cc3'];}?></td>
	  <td><?php  if($r['apperss_ch4']!='')    { echo "'".$r['apperss_ch4'];}?></td>
      <td><?php  if($r['apperss_sf1']!='')      { echo "'".$r['apperss_sf1'];}?></td>
      <td><?php  if($r['apperss_sf2']!='')      { echo "'".$r['apperss_sf2'];}?></td>
	  <td><?php  if($r['apperss_sf3']!='')      { echo "'".$r['apperss_sf3'];}?></td>
      <td><?php  if($r['apperss_sf4']!='')   { echo "'".$r['apperss_sf4'];}?></td>
      <td><?php  if($r['apperss_sb1']!='')   { echo "'".$r['apperss_sb1'];}?></td>
	  <td><?php  if($r['apperss_sb2']!='')     { echo "'".$r['apperss_sb2'];}?></td>
      <td><?php  if($r['apperss_sb3']!='')     { echo "'".$r['apperss_sb3'];}?></td>
      <td><?php  if($r['apperss_sb4']!='')    { echo "'".$r['apperss_sb4'];}?></td>
	  ...
	  <td><?php echo $r['nedle'] ?></td>
	   <td><?php echo $r['nedle_note'] ?></td>
      ...
      <td><?php echo $r['bleeding'];?></td>
	   <td><?php echo $r['bleeding_root'];?></td>
