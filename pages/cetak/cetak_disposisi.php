...
<table width="100%">
  ...
  //$qry1=mysqli_query($con,"SELECT * FROM tbl_aftersales_now $Where $shft $subdpt $disposisi $lgn ORDER BY pejabat ASC");
        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            <tr>
                ...
                <td align="right"><strong><?php echo ($TotalKirim != "") ? number_format($TotalKirim, 2) . " Kg" : "0.00 Kg"; ?></strong></td>
            </tr>
            <tr>
