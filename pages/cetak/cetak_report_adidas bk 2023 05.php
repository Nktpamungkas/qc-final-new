...
<title>Print Report Physical Adidas</title>
<style>
.hurufvertical {
 writing-mode:tb-rl;
...
<table width="100%">
            ...
            <td><table width="100%" border="0" class="table-list1">  
                <tr>
                    <td align="center" colspan="8" valign="middle" style="border-top:0px #000000 solid; 
                                ...
                                border-right:0px #000000 solid;"><strong><font size="-2" >FABRIC TEST REPORT</font> <br> FW-12-QCF-04/02</strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="right" style="border-top:0px #000000 solid; 
                                border-bottom:0px #000000 solid;
                                border-left:0px #000000 solid; 
                                border-right:0px #000000 solid;">Version : Sep 2021V2</td>
                </tr>
                </table>
                ...
                <!--<tr>
                    <td colspan="8" align="center" style="font-size: 11px;"><strong>Fabric Physical Tests</strong></td>
                </tr> -->
            </table></td>
    ...
    <tr>
        ...
        <tr>
            <td align="left" rowspan="2" style="font-size: 8px;" valign="top"><strong>PHX-AP0701</strong></td>
            ...
            <td align="left" rowspan="2" style="font-size: 8px;" valign="top"><strong>Dimensional Change<br><br>Spirality<br>Appearance Change After Laundering</strong><br>30&deg;C (&nbsp;) ref.only<br>40&deg;C (&#10003)<br>60&deg;C (&nbsp;)<br>Please Place &#10003; Againts Appropriate Test<br>Temperature</td>
            <td align="left" style="font-size: 8px;">See Test Method<br>X1 Wash<br>Spirality<br>Appearance: No Change<br>colour change of &ge; 4-5</td>
            ...
            <td align="center" rowspan="2" style="font-size: 8px;"><?php if($rcek1['stat_fwss']=="A" OR $rcek1['stat_fwss']=="PASS" OR $rcek1['stat_fwss']=="FAIL" OR $rcek1['stat_fwss']=="RANDOM" OR $rcek1['stat_fwss']=="DISPOSISI"){echo "A";}?></td>
            <td align="center" rowspan="2" style="font-size: 8px;"><?php if($rcek1['stat_fwss']=="R"){echo "R";}?></td>
        </tr>
        <tr>
            <td align="left" style="font-size: 8px;">See Test Method<br>(&#10003;)X3 Washes<br>( )X10 Washes<br>( )X15 Washes<br>Appearance: No Change<br>colour change of &ge; 4-5</td>
            <td align="center" style="font-size: 8px;">
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;" valign="top"><strong>Heat Shrinkage</strong><br>*Heat Process: 170&deg;C +/-2&deg;C/15sec./2bar()<br>Bonding :180&deg;C +/-2&deg;C/ 15sec./2bar()<br>Molding :200&deg;C +/-2&deg;C/ 15sec./2bar()<br>Please Place &#10003; Againts Approproate Test<br>Temperature</td>
        ...
        <tr>
            ...
            <td align="center" style="font-size: 8px;" valign="top"><strong>K</strong></td>
            <td align="center" style="font-size: 8px;" valign="top"><strong>NS</strong></td>
            <td align="left" style="font-size: 8px;" valign="top"><strong>Bursting Strength</strong><br>*only for all knitted fabrics and knitted fabrics with<br>laser cut elements/holes</td>
            <td align="left" style="font-size: 8px;" >Natural(>50%):<br>220 g/m<sup>2</sup> or lower &ge; 130 kPa<br>221 g/m<sup>2</sup> or above &ge; 170 kPa<br>Synthetic(>50%):<br>220 g/m<sup>2</sup> or lower &ge; 170 kPa<br>221 g/m<sup>2</sup> or above &ge; 250 kPa<br><br>Teamwear &ge; 450 kPa</td>
            <td align="center" style="font-size: 8px;" >
            <?php if($rcek1['stat_bs']=="RANDOM"){echo $rcekR['rbs_tru'];}else if($rcek1['stat_bs']=="DISPOSISI"){echo $rcekD['dbs_tru'];}else{echo $rcek1['bs_tru'];}?>
            </td>
            <td align="left" style="font-size: 8px;" >(kPa)<br></td>
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;" >(inches)</td>
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;" >500rev.: &ge;3-4*(3 for cotton content)<br><br>2000rev.: &ge;3-4*(3 for cotton content)</td>
            <td align="center" style="font-size: 8px;" >
            ...
            <td align="left" style="font-size: 8px;" >(grade)<br><br>(grade)</td>
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;" >4.0-7.5</td>
            <td align="center" style="font-size: 8px;" >
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;" >Bow &amp; Skew target for Woven: &le; 3%<br>Bow &amp; Skew target for Knitted: &le; 5%<br></td>
        ...
        <tr>
            ...
            <td align="left" style="font-size: 8px;" >4-5 Color Change<br><br>4 Acetate<br><br>4 Cotton<br><br>4 Nylon<br><br>4 Polyester<br><br>4 Acrylic<br><br>4 Wool<br><br>4-5 Color Staining</td>
            <td align="center" style="font-size: 8px;" >
        ...
        <tr>
            ...
            <td align="center" style="font-size: 8px;" valign="top"><strong>KW</strong></td>
            <td align="center" style="font-size: 8px;" valign="top"><strong>NS</strong></td>
            <td align="left" style="font-size: 8px;" valign="top"><strong>Crocking Fastness</strong><br><br>*Dark Colour:<br>Dry: >3 (infants: > 4)<br>Wet: >2 (infants: > 3)</td>
        ...
        <!--<tr>
            <td align="left" style="font-size: 8px;" valign="top"><strong>PHM-AP0514</strong></td>
            <td align="center" style="font-size: 8px;" valign="top"><strong>KW</strong></td>
            <td align="center" style="font-size: 8px;" valign="top"><strong>NS</strong></td>
        ...
        <tr>
            <td align="left" style="font-size: 8px;" valign="top"><strong>PHM-AP0515</strong></td>
            <td align="center" style="font-size: 8px;" valign="top"><strong>KW</strong></td>
            <td align="center" style="font-size: 8px;" valign="top"><strong>NS</strong></td>
            <td align="left" style="font-size: 8px;" valign="top"><strong>Color Migration Fastness</strong><br><br>90&deg;C x 24h(<?php if($rcek1['cm_dye_temp']=='90'){echo "&#10003;"; }?>)<br>70&deg;C x 48h(<?php if($rcek1['cm_dye_temp']=='70'){ echo "&#10003;"; }?>)<br><br>*Only test on the fabric contains<br>any synthetic fiber add paper<br>tissue insert result for ref.</td>
            <td align="left" style="font-size: 8px;" >4-5 Color Change<br><br><br><br>4 Color Staining</td>
            <td align="center" style="font-size: 8px;" >
            <?php if($rcek1['stat_cm']=="RANDOM"){echo $rcekR['rcm_dye_colorchange'];}else if($rcek1['stat_cm']=="DISPOSISI"){echo $rcekD['dcm_dye_colorchange'];}else{echo $rcek1['cm_dye_colorchange'];}?><br><br><br><br>
            <?php if($rcek1['stat_cm']=="RANDOM"){echo $rcekR['rcm_dye_stainingface'];}else if($rcek1['stat_cm']=="DISPOSISI"){echo $rcekD['dcm_dye_stainingface'];}else{echo $rcek1['cm_dye_stainingface'];}?>
            </td>
            <td align="left" style="font-size: 8px;" >(grade)<br><br><br><br>(grade)</td>
        ...
        <tr>
            ...
            <td align="left" colspan="8" style="font-size: 10px;"><strong><?php echo $rcekbs['note_bs'];?></strong></td>
        </tr>
