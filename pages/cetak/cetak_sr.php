...
<body>
    ...
    <table width="100%" border="1" class="table-list1">
        ...
        <tbody>
            <?php
                $query=mysqli_query($con,"SELECT * FROM tbl_tq_randomtest WHERE DATE_FORMAT( tgl_update, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND (rstretch_l1!='' OR rstretch_w1!='' OR rrecover_l1!='' OR rrecover_w1!='') GROUP BY no_item ");
