...
header("Content-Disposition: attachment; filename=Cancel/Disposisi-NCP-QC-".substr($_GET['awal'],0,10).".xls");//ganti nama sesuai keperluan
...
<table width="100%" border="1">
    <tr>
        <th colspan="17" bgcolor="#F2DD0F" align="center">LAPORAN NCP DISPOSISI</th>
    </tr>
    <tr>
    ...
    <?php 
    $no=1;
    $qry1=mysqli_query($con,"SELECT * FROM tbl_ncp_qcf WHERE DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' AND '$Akhir' AND `status`='Disposisi' ORDER BY dibuat_oleh ASC");
