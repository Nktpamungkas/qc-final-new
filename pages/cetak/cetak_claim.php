...
<table width="100%">
  ...
  <tr>
        <td align="center"><strong><font size="+1">LAPORAN CLAIM AKIBAT KELOLOSAN QCF</font><br />
      ...
      <td><table width="100%" border="1" class="table-list1">
        <thead>
          <tr align="center">
            ...
            <td><font size="-2"><strong>ISSUE</strong></font></td>
        ...
        while($row1=mysqli_fetch_array($qry1)){
		 ?>
          <tr valign="top">
            ...
            <td align="right" valign="middle"><font size="-2"><?php echo date("M Y", strtotime($row1['tgl_buat']));?></font></td>
            <td align="left" valign="middle"><font size="-2"><?php echo strtoupper($row1['langganan']);?></font></td>
            <td align="left" valign="middle"><font size="-2"><?php echo strtoupper($row1['po']);?></font></td>
            <td align="left" valign="middle"><font size="-2"><?php echo strtoupper($row1['no_order']);?></font></td>
            ...
            <td align="left" valign="middle"><font size="-2"><?php echo strtoupper($row1['masalah']);?></font></td>
            <td align="left" valign="middle"><font size="-2"><?php echo strtoupper($row1['ket']);?></font></td>
          </tr>
        <?php $no++;
        } 
        ?>
