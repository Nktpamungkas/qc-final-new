...
<table width="100%" border="1">
    ...
    if($_GET['personil']=="ALL"){		
        ...
        AND '$_GET[akhir]' $Wnama $Wshift $WGshift GROUP BY a.personil,b.shift
        ...
        while($r=mysqli_fetch_array($sql)){
             ...
             ON 
                 a.id_schedule=b.id  
             WHERE
                 DATE_FORMAT( a.tgl_update, '%Y-%m-%d %H:%i' ) BETWEEN '$_GET[awal]' AND '$_GET[akhir]' AND proses='Inspect Finish' AND a.personil='$r[personil]' AND b.shift='$r[shift]'");
            ...
            WHERE
                ...
                AND '$_GET[akhir]' AND proses='Inspect Qty Kecil' AND a.personil='$r[personil]' AND b.shift='$r[shift]' ");
            ...
            WHERE
                DATE_FORMAT( a.tgl_update, '%Y-%m-%d %H:%i' ) BETWEEN '$_GET[awal]' 
                AND '$_GET[akhir]' AND proses='Inspect White' AND a.personil='$r[personil]' AND b.shift='$r[shift]' ");
            ...
            WHERE
                DATE_FORMAT( a.tgl_update, '%Y-%m-%d %H:%i' ) BETWEEN '$_GET[awal]' 
                AND '$_GET[akhir]' AND proses='Inspect Oven' AND a.personil='$r[personil]' AND b.shift='$r[shift]' ");
    ...
    <tr>
        ...
        <td align="right"><?php echo $rInsLulu['rolInsLulu'];?></td>
        <td align="right"><?php echo $rInsLulu['brutoInsLulu'];?></td>
        <td align="right"><?php echo $rInsLulu['panjangInsLulu'];?></td>
        <td align="right"><?php echo $targetInsLulu= number_format(($rInsLulu['panjangInsLulu']/2500*100)/$r['hari_kerja'],2); ?></td>
        <td align="right"><?php echo $rInsAds['rolInsAds'];?></td>
        <td align="right"><?php echo $rInsAds['brutoInsAds'];?></td>
        <td align="right"><?php echo $rInsAds['panjangInsAds'];?></td>
        <td align="right"><?php echo $targetInsAds= number_format(($rInsAds['panjangInsAds']/3000*100)/$r['hari_kerja'],2); ?></td>
        <td align="right"><?php echo $rIQKLulu['rolIQKLulu'];?></td>
        <td align="right"><?php echo $rIQKLulu['brutoIQKLulu'];?></td>
        <td align="right"><?php echo $rIQKLulu['panjangIQKLulu'];?></td>
        <td align="right"><?php echo $targetIQKLulu= number_format(($rIQKLulu['panjangIQKLulu']/1500*100)/$r['hari_kerja'],2); ?></td>
        <td align="right"><?php echo $rIQKAds['rolIQKAds'];?></td>
        <td align="right"><?php echo $rIQKAds['brutoIQKAds'];?></td>
        <td align="right"><?php echo $rIQKAds['panjangIQKAds'];?></td>
        <td align="right"><?php echo $targetIQKAds= number_format(($rIQKAds['panjangIQKAds']/2100*100)/$r['hari_kerja'],2); ?></td>
        <td align="right"><?php echo $rWLulu['rolWLulu'];?></td>
        <td align="right"><?php echo $rWLulu['brutoWLulu'];?></td>
        <td align="right"><?php echo $rWLulu['panjangWLulu'];?></td>
        <td align="right"><?php echo $targetIWLulu= number_format(($rWLulu['panjangWLulu']/1500*100)/$r['hari_kerja'],2); ?></td>
        <td align="right"><?php echo $rWAds['rolWAds'];?></td>
        <td align="right"><?php echo $rWAds['brutoWAds'];?></td>
        <td align="right"><?php echo $rWAds['panjangWAds'];?></td>
        <td align="right"><?php echo $targetIWAds= number_format(($rWAds['panjangWAds']/2000*100)/$r['hari_kerja'],2); ?></td>
        ...
        <td align="right"><?php echo $rInsLulu['panjangInsLulu']+$rInsAds['panjangInsAds']+$rIQKLulu['panjangIQKLulu']+$rIQKAds['panjangIQKAds']+$rWLulu['panjangWLulu']+$rWAds['panjangWAds']+$rO['panjangO']+$rPack['panjangPack']+$rP['panjangP']+$rPb['panjangPb']+$rPG['panjangPG']+$rIP['panjangIP'];?></td>
    </tr>
    <?php
    // if($r['t_jawab']=='Asst. SPV'){
    $troll_InsLulu      = $troll_InsLulu+$rInsLulu['rolInsLulu'];
    $tbruto_InsLulu     = $tbruto_InsLulu+$rInsLulu['brutoInsLulu'];
    $tpanjang_InsLulu   = $tpanjang_InsLulu+$rInsLulu['panjangInsLulu'];
    $troll_IQKLulu      = $troll_IQKLulu+$rIQKLulu['rolIQKLulu'];
    $tbruto_IQKLulu     = $tbruto_IQKLulu+$rIQKLulu['brutoIQKLulu'];
    $tpanjang_IQKLulu   = $tpanjang_IQKLulu+$rIQKLulu['panjangIQKLulu'];
    $troll_WLulu        = $troll_WLulu+$rWLulu['rolWLulu'];
    $tbruto_WLulu       = $tbruto_WLulu+$rWLulu['brutoWLulu'];
    $tpanjang_WLulu     = $tpanjang_WLulu+$rWLulu['panjangWLulu'];
    //}
    // if($r['t_jawab']=='Leader'){
    $troll_InsAds       = $troll_InsAds+$rInsAds['rolInsAds'];
    $tbruto_InsAds      = $tbruto_InsAds+$rInsAds['brutoInsAds'];
    $tpanjang_InsAds    = $tpanjang_InsAds+$rInsAds['panjangInsAds'];
    $troll_IQKAds       = $troll_IQKAds+$rIQKAds['rolIQKAds'];
    $tbruto_IQKAds      = $tbruto_IQKAds+$rIQKAds['brutoIQKAds'];
    $tpanjang_IQKAds    = $tpanjang_IQKAds+$rIQKAds['panjangIQKAds'];
    $troll_WAds         = $troll_WAds+$rWAds['rolWAds'];
    $tbruto_WAds        = $tbruto_WAds+$rWAds['brutoWAds'];
    $tpanjang_WAds      = $tpanjang_WAds+$rWAds['panjangWAds'];
    //}
    ...
    <tr>
        ...
        <td align="right"><strong><?php echo $tpanjang_InsLulu+$tpanjang_InsAds+$tpanjang_IQKLulu+$tpanjang_InsAds+$tpanjang_WLulu+$tpanjang_WAds+$tpanjang_O+$tpanjang_Pack+$tpanjang_P+$tpanjang_Pb+$tpanjang_PG+$tpanjang_IP;?></strong></td>
    </tr>
</table>