        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            <tr>
              <?php
              if($_GET['langganan']!=""){ $lgn =" AND langganan LIKE '%$_GET[langganan]%' "; }else{$lgn = " ";}
              $qry1=mysqli_query($con,"SELECT shift, shift2, if(shift2!='' AND shift2!='A',qty_claim/2,qty_claim) as qty_claim_a FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='A' OR shift2='A') $lgn"); 
              $tot_a=0;
              while($row1=mysqli_fetch_array($qry1)){
            ...
            <tr>
            <?php
              $qry2=mysqli_query($con,"SELECT shift, shift2, if(shift2!='' AND shift2!='B',qty_claim/2,qty_claim) as qty_claim_b FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='B' OR shift2='B') $lgn"); 
              $tot_b=0;
            ...
            <tr>
            <?php
              $qry3=mysqli_query($con,"SELECT shift, shift2, if(shift2!='' AND shift2!='C',qty_claim/2,qty_claim) as qty_claim_c FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='C' OR shift2='C') $lgn"); 
              $tot_c=0;
            ...
            <tr>
            <?php
              $qry4=mysqli_query($con,"SELECT shift, shift2, if(shift2!='' AND shift2!='Non-Shift',qty_claim/2,qty_claim) as qty_claim_non FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Non-Shift' OR shift2='Non-Shift') $lgn"); 
              $tot_non=0;
            ...
            <tr>
              <?php
              $qry5=mysqli_query($con,"SELECT shift, shift2, if(shift2!='' AND shift2!='QC2',qty_claim/2,qty_claim) as qty_claim_qc2 FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='QC2' OR shift2='QC2') $lgn"); 
              $tot_qc2=0;
              ...
              <tr>
              <?php
              $qry6=mysqli_query($con,"SELECT shift, shift2, if(shift2!='' AND shift2!='Test Quality',qty_claim/2,qty_claim) as qty_claim_tq FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (shift='Test Quality' OR shift2='Test Quality') $lgn"); 
              $tot_tq=0;
        ...
        <tr>
          <td style="border-top:0px #000000 solid; 
            ...
            <tr>
              ...
              (SELECT DISTINCT personil, pejabat, shift, SUM(IF(shift2!='',qty_claim/2,qty_claim)) AS qty_claim FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              ...
              (SELECT personil2, shift2, SUM(IF(shift2!='',qty_claim/2,qty_claim)) AS qty_claim2 FROM tbl_aftersales_now WHERE
              DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
              AND '$Akhir' AND sts='1' AND sts_revdis='0' AND personil2!='' $lgn $subdpt GROUP BY personil2, shift2 ORDER BY shift2 ASC) AS B
              ORDER BY shift ASC");
              ...
              while($row1=mysqli_fetch_array($qry1)){
                ...
                DATE_FORMAT( tgl_buat, '%Y-%m-%d' ) BETWEEN '$Awal' 
                AND '$Akhir' AND sts='1' AND sts_revdis='0' AND (IF(pejabat!='',pejabat='$row1[pejabat]',personil='$row1[personil]') OR personil2='$row1[personil]') AND (shift='$row1[shift]' OR shift2='$row1[shift]') $lgn $subdpt");
                $rowjml1=mysqli_fetch_array($qryjml1);
