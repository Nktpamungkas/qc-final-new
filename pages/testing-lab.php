...
<script>
	...
	function hitung() {
		...
		var total;
		if (cott > 0) {
			cott = document.forms['form1']['fc_cott'].value;
		} else {
			cott = 0;
		}
		if (poly > 0) {
			poly = document.forms['form1']['fc_poly'].value;
		} else {
			poly = 0;
		}
		if (elastane > 0) {
			elastane = document.forms['form1']['fc_ela'].value;
		} else {
			elastane = 0;
		}
	...
	function hitungdis() {
		...
		var dtotal;
		if (dcott > 0) {
			dcott = document.forms['form1']['dfc_cott'].value;
		} else {
			dcott = 0;
		}
		if (dpoly > 0) {
			dpoly = document.forms['form1']['dfc_poly'].value;
		} else {
			dpoly = 0;
		}
		if (delastane > 0) {
			delastane = document.forms['form1']['dfc_ela'].value;
		} else {
			delastane = 0;
		}
			...
			<div class="box-body">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="input-group">
								<input name="nocount" type="text" class="form-control" id="nocount" value="<?php echo $_GET['nocount']; ?>" onchange="window.location='TestingLab-'+this.value" placeholder="No Counter" required <?php if ($_SESSION['lvl_id'] == "TQ") {
																																																										echo "readonly";
																																																									} ?>>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input name="buyer" type="text" class="form-control" id="buyer" placeholder="Buyer" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
						<label for="item" class="col-sm-3 control-label">Item</label>
						<div class="col-sm-5">
							<input name="item" type="text" class="form-control" id="item" placeholder="Item" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
		...
		<div class="box-body">
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							<input name="nocount" type="text" class="form-control" id="nocount" onchange="window.location='TestingLab-'+this.value" value="<?php echo $_GET['nocount']; ?>" placeholder="No Counter" required <?php if ($_SESSION['lvl_id'] == "TQ") {
																																																									echo "readonly";
																																																								} ?>>
						</div>
					</div>
				...
				<div class="form-group">
					<label for="item" class="col-sm-3 control-label">Item</label>
					<div class="col-sm-4">
						<input name="item" type="text" class="form-control" id="item" placeholder="Item" value="<?php if ($cek > 0) {
																													echo $rcek['no_item'];
																												} ?>" readonly="readonly">
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="form-group">
					<label for="no_warna" class="col-sm-3 control-label">No Warna</label>
					<div class="col-sm-8">
						<textarea name="no_warna" readonly="readonly" class="form-control" id="no_warna" placeholder="No Warna"><?php if ($cek > 0) {
																																	echo $rcek['no_warna'];
																																} ?></textarea>
					</div>
				</div>
						...
						<div class="tab-pane active" id="tab_2">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form2" id="form2">
								...
								<div class="form-group" id="c1" style="display:none;">
									...
									<div class="col-sm-1">
										<label><input type="checkbox" name="wash_temp" id="wash_temp" class="minimal" value="30" <?php if ($rcek1['wash_temp'] == '30') {
																																		echo "checked";
																																	} ?>> 30&deg;C &nbsp; &nbsp; &nbsp; &nbsp;
										</label>
										<label><input type="checkbox" name="wash_temp" id="wash_temp" class="minimal" value="40" <?php if ($rcek1['wash_temp'] == '40') {
																																		echo "checked";
																																	} ?>> 40&deg;C
										</label>
										<label><input type="checkbox" name="wash_temp" id="wash_temp" class="minimal" value="60" <?php if ($rcek1['wash_temp'] == '60') {
																																		echo "checked";
																																	} ?>> 60&deg;C
										</label>
									</div>
								...
								<div class="form-group" id="diswf" style="display:none;">
									...
									<div class="col-sm-1">
										<label><input type="checkbox" name="dwash_temp" id="dwash_temp" class="minimal" value="30" <?php if ($rcekD['dwash_temp'] == '30') {
																																		echo "checked";
																																	} ?>> 30&deg;C &nbsp; &nbsp; &nbsp; &nbsp;
										</label>
										<label><input type="checkbox" name="dwash_temp" id="dwash_temp" class="minimal" value="40" <?php if ($rcekD['dwash_temp'] == '40') {
																																		echo "checked";
																																	} ?>> 40&deg;C
										</label>
									</div>
								...
								<div class="form-group" id="marwf" style="display:none;">
									...
									<div class="col-sm-1">
										<label><input type="checkbox" name="mwash_temp" id="mwash_temp" class="minimal" value="30" <?php if ($rcekM['mwash_temp'] == '30') {
																																		echo "checked";
																																	} ?>> 30&deg;C &nbsp; &nbsp; &nbsp; &nbsp;
										</label>
										<label><input type="checkbox" name="mwash_temp" id="mwash_temp" class="minimal" value="40" <?php if ($rcekM['mwash_temp'] == '40') {
																																		echo "checked";
																																	} ?>> 40&deg;C
										</label>
									</div>
								...
								<div class="form-group" id="ranwf" style="display:none;">
									...
									<div class="col-sm-1">
										<label><input type="checkbox" name="rwash_temp" id="rwash_temp" class="minimal" value="30" <?php if ($rcekR['rwash_temp'] == '30') {
																																		echo "checked";
																																	} ?> readonly> 30&deg;C &nbsp; &nbsp; &nbsp; &nbsp;
										</label>
										<label><input type="checkbox" name="rwash_temp" id="rwash_temp" class="minimal" value="40" <?php if ($rcekR['rwash_temp'] == '40') {
																																		echo "checked";
																																	} ?> readonly> 40&deg;C
										</label>
									</div>
								...
								<div class="form-group" id="c8" style="display:none;">
									...
									<div class="col-sm-2">
										<label><input type="checkbox" name="cm_dye_temp" id="cm_dye_temp" class="minimal" value="90" <?php if ($rcek1['cm_dye_temp'] == '90') {
																																			echo "checked";
																																		} ?>> 90&deg;C x 24h &nbsp; &nbsp; &nbsp; &nbsp;
										</label>
										<label><input type="checkbox" name="cm_dye_temp" id="cm_dye_temp" class="minimal" value="70" <?php if ($rcek1['cm_dye_temp'] == '70') {
																																			echo "checked";
																																		} ?>> 70&deg;C x 48h
										</label>
									</div>
								...
								<div class="form-group" id="discm" style="display:none;">
									...
									<div class="col-sm-2">
										<label><input type="checkbox" name="dcm_dye_temp" id="dcm_dye_temp" class="minimal" value="90" <?php if ($rcekD['dcm_dye_temp'] == '90') {
																																			echo "checked";
																																		} ?>> 90&deg;C x 24h &nbsp; &nbsp; &nbsp; &nbsp;
										</label>
										<label><input type="checkbox" name="dcm_dye_temp" id="dcm_dye_temp" class="minimal" value="70" <?php if ($rcekD['dcm_dye_temp'] == '70') {
																																			echo "checked";
																																		} ?>> 70&deg;C x 48h
										</label>
									</div>
								...
								<div class="form-group" id="rancm" style="display:none;">
									...
									<div class="col-sm-2">
										<label><input type="checkbox" name="rcm_dye_temp" id="rcm_dye_temp" class="minimal" value="90" <?php if ($rcekR['rcm_dye_temp'] == '90') {
																																			echo "checked";
																																		} ?> readonly> 90&deg;C x 24h &nbsp; &nbsp; &nbsp; &nbsp;
										</label>
										<label><input type="checkbox" name="rcm_dye_temp" id="rcm_dye_temp" class="minimal" value="70" <?php if ($rcekR['rcm_dye_temp'] == '70') {
																																			echo "checked";
