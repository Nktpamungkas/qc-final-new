...
include("../koneksi.php");
    $modal_id=$_GET['id'];
	$modal=mysqli_query($con,"SELECT * FROM `tbl_conform_qc` WHERE file_foto3='$modal_id'");
                ...
                <div class="modal-body">
                    <div class="wrapped">
                        <div class="modal-zoom-large-photo-wrap">
                            <div class="absolute">
                                <a id="modal-zoom-photo" class="zoom-in-cursor" href="#"><img class="margin-bottom img-responsive" src="dist/img-disposisinow/<?php echo $r['file_foto3'];?>"></a>
                            </div>
                        </div>
                    </div>
                </div>
