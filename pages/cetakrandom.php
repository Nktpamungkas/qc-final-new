    ...
    <div class="box-body">
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
            ...
            <tr>
                ...
                <td align="center">
                <?php if($r['rprt_f1']!=""){ ?>
                    F: <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rprt_f1'] ?>" class="rprt_f1" href="javascript:void(0)"><?php echo $r['rprt_f1'] ?></a>
                <?php } ?>
                &nbsp;
                <?php if($r['rprt_b1']!=""){ ?>
                    B: <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rprt_b1'] ?>" class="rprt_b1" href="javascript:void(0)"><?php echo $r['rprt_b1'] ?></a>
                <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rpb_f1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rpb_f1'] ?>" class="rpb_f1" href="javascript:void(0)"><?php echo $r['rpb_f1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_grdl1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_grdl1'] ?>" class="rsp_grdl1" href="javascript:void(0)"><?php echo $r['rsp_grdl1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_clsl1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_clsl1'] ?>" class="rsp_clsl1" href="javascript:void(0)"><?php echo $r['rsp_clsl1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_shol1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_shol1'] ?>" class="rsp_shol1" href="javascript:void(0)"><?php echo $r['rsp_shol1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_medl1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_medl1'] ?>" class="rsp_medl1" href="javascript:void(0)"><?php echo $r['rsp_medl1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_lonl1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_lonl1'] ?>" class="rsp_lonl1" href="javascript:void(0)"><?php echo $r['rsp_lonl1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_grdw1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_grdw1'] ?>" class="rsp_grdw1" href="javascript:void(0)"><?php echo $r['rsp_grdw1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_clsw1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_clsw1'] ?>" class="rsp_clsw1" href="javascript:void(0)"><?php echo $r['rsp_clsw1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_show1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_show1'] ?>" class="rsp_show1" href="javascript:void(0)"><?php echo $r['rsp_show1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_medw1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_medw1'] ?>" class="rsp_medw1" href="javascript:void(0)"><?php echo $r['rsp_medw1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_lonw1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_lonw1'] ?>" class="rsp_lonw1" href="javascript:void(0)"><?php echo $r['rsp_lonw1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_grdl2']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_grdl2'] ?>" class="rsp_grdl2" href="javascript:void(0)"><?php echo $r['rsp_grdl2'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsp_grdw2']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsp_grdw2'] ?>" class="rsp_grdw2" href="javascript:void(0)"><?php echo $r['rsp_grdw2'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rsm_l1']!=""){ ?>
                        L= <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsm_l1'] ?>" class="rsm_l1" href="javascript:void(0)"><?php echo $r['rsm_l1'] ?></a>
                    <?php } ?>
                    &nbsp;
                    <?php if($r['rsm_w1']!=""){ ?>
                        W= <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rsm_w1'] ?>" class="rsm_w1" href="javascript:void(0)"><?php echo $r['rsm_w1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rbs_instron']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rbs_instron'] ?>" class="rbs_instron" href="javascript:void(0)"><?php echo $r['rbs_instron'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rbs_tru']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rbs_tru'] ?>" class="rbs_tru" href="javascript:void(0)"><?php echo $r['rbs_tru'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rbs_mullen']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rbs_mullen'] ?>" class="rbs_mullen" href="javascript:void(0)"><?php echo $r['rbs_mullen'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rpm_f1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rpm_f1'] ?>" class="rpm_f1" href="javascript:void(0)"><?php echo $r['rpm_f1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rpm_f2']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rpm_f2'] ?>" class="rpm_f2" href="javascript:void(0)"><?php echo $r['rpm_f2'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                ...
                <td align="center">
                    ...
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rstretch_w1'] ?>" class="rstretch_w1" href="javascript:void(0)"><?php echo $r['rstretch_w1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                ...
                <td align="center">
                    ...
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rrecover_w1'] ?>" class="rrecover_w1" href="javascript:void(0)"><?php echo $r['rrecover_w1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rwick_l2']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rwick_l2'] ?>" class="rwick_l2" href="javascript:void(0)"><?php echo $r['rwick_l2'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rwick_w2']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rwick_w2'] ?>" class="rwick_w2" href="javascript:void(0)"><?php echo $r['rwick_w2'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rabsor_b1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rabsor_b1'] ?>" class="rabsor_b1" href="javascript:void(0)"><?php echo $r['rabsor_b1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rdryaf1']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rdryaf1'] ?>" class="rdryaf1" href="javascript:void(0)"><?php echo $r['rdryaf1'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rbow']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rbow'] ?>" class="rbow" href="javascript:void(0)"><?php echo $r['rbow'] ?></a>
                    <?php } ?>
                </td>
                <td align="center">
                    <?php if($r['rskew']!=""){ ?>
                    <a data-pk="<?php echo $r['id'] ?>" data-value="<?php echo $r['rskew'] ?>" class="rskew" href="javascript:void(0)"><?php echo $r['rskew'] ?></a>
                    <?php } ?>
                </td>
            </tr>
            <?php } ?>
