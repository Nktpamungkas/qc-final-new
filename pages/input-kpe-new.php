	 		...
	 		<div class="col-md-6"> 
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						onchange="window.location='KPENew-'+this.value" value="<?php echo $_GET['nodemand'];?>" placeholder="No Demand" required >
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						value="<?php if($cek>0){echo $rcek['langganan'];}else{if($rowdb2['LEGALNAME1']!=""){echo $rowdb2['LEGALNAME1']."/".$rowdb2['BUYER'];}}?>" placeholder="Pelanggan" >
						<input name="pelanggan1" type="hidden" class="form-control" id="pelanggan1" 
						value="<?php if($cek>0){echo $rcek['pelanggan'];}else{if($rowdb2['LEGALNAME1']!=""){echo $rowdb2['LEGALNAME1'];}}?>" placeholder="Pelanggan" >
					</div>				   
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						value="<?php if($cek>0){echo $rcek['jenis_kain'];}else{echo stripslashes($rowdb2['JENIS_KAIN']);}?>" placeholder="Jenis Kain">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						value="<?php if($cek>0){echo $rcek['warna'];}else{ if($rowdb2['WARNA']=="PFD"){echo stripslashes($rowdb2['WARNA'])." (".$rowdb2['COLORPFD'].")";}else{echo stripslashes($rowdb2['WARNA']);}}?>" placeholder="Warna">
					</div>				   
					<div class="col-sm-4">
                  	...
                  	<label for="proses" class="col-sm-3 control-label">Qty Order / Kirim</label>
          				<div class="col-sm-4">
                    		<div class="input-group">  
								<input name="qty_order" type="text" class="form-control" id="qty_order" value="<?php if($cek>0){echo $rcek['qty_order'];}else{ echo number_format($rowdb2['QTY_ORDER'],2);} ?>" placeholder="0.00" style="text-align: right;" required>
								<span class="input-group-addon"><select name="satuan_o" style="font-size: 12px;" id="satuan1">
								<option value="KG" <?php if($rcek['satuan_o']=="KG"){ echo "SELECTED"; }else if($rowdb2['QTY_PANJANG_ORDER_UOM']=="kg"){ echo "SELECTED";}?>>KG</option>
								<option value="PCS" <?php if($rcek['satuan_o']=="PCS"){ echo "SELECTED"; }else if($rowdb2['QTY_PANJANG_ORDER_UOM']=="un"){ echo "SELECTED";}?>>PCS</option>
								</select></span>	
							</div>
                  		</div>				   
          				<div class="col-sm-4">
	  		...
	  		<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
								<div class="input-group date">
									...
									<input  name="hod" type="text" class="form-control pull-right" id="datepicker4" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['hod'];} ?>" />
								</div>
						</div>
				</div>
				...
				<div class="form-group">		  	
					...
					<div class="col-sm-4">					  
						<div class="input-group date">
							<div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
								<input  name="tgl_email" type="text" class="form-control pull-right" id="datepicker" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['tgl_email'];} ?>" <?php  if($rcek['sts_red']!="1"){ echo "";}else{ echo ""; } ?>/>
						</div>
					</div>
					<div class="col-sm-4">					  
						<div class="input-group date">
							<div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
								<input  name="tgl_jawab" type="text" class="form-control pull-right" id="datepicker1" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['tgl_jawab'];} ?>" <?php  if($rcek['sts_red']!="1"){ echo "";}else{ echo ""; } ?>/>
						</div>
					</div>
				...
				<div class="form-group">		  	
					...
					<div class="col-sm-4">					  
						<div class="input-group date">
							<div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
								<input  name="tgl_solusi_akhir" type="text" class="form-control pull-right" id="datepicker2" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['tgl_solusi_akhir'];} ?>" <?php  if($rcek['sts_red']!="1"){ echo "";}else{ echo ""; } ?>/>
						</div>
					</div>
				</div>
