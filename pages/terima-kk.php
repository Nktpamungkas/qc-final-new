...
<div class="row"> 
     <div class="col-lg-12">
          <div class="box">
			...
			<h3 class="box-title">Data Serah Terima KK</h3>
			<div class="form-group pull-right">
				     <button class="btn btn-danger" type="Button" name="save" value="Save"><i class="fa fa-save"></i> Save </button>					 
				</div>	
			</div>
            <!-- /.card-header -->
            <div class="box-body table-responsive">
<table id="example" width="100%" class="table table-bordered table-hover table-striped nowrap" style="font-size: 14px;">
 <thead class="btn-success">
  ...
  <?php 
$no=1;  
$qry=mysqli_query($con,"SELECT *,if(isnull(tgl_serah) and isnull(tgl_terima), 'Masih di GKJ',if(not isnull(tgl_serah) and isnull(tgl_terima),'Sudah Diserahkan','')) as sts FROM tbl_serah_terimakk WHERE isnull(user_terima) and isnull(tgl_terima) ORDER BY sts, id ASC");
...
?>
  <tr align="center">
    ...
    <td align="center"><?php if($rowd['sts']=="Belum diterima"){echo "<span class='label label-danger'>".$rowd['sts']."</span>";}else{ echo  "<span class='label label-success'>".$rowd['sts']."</span>";}?></td>
