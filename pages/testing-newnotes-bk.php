      			...
      			<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="input-group">
							...
							onchange="window.location='TestingNew-'+this.value" value="<?php if($cek>0){echo $rcek['nodemand'];}else{echo $_GET['nodemand'];} ?>" placeholder="No Demand" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>
					</div>
