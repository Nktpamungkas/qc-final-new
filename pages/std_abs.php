            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Absorbency</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder="" rows="3">Original :<?php if($r['absor_f2']!="" or $rcekR['rabsor_f2']!=""){?>&#13;&#10;Face= <?php if($r['stat_abs']=="RANDOM"){echo $rcekR['rabsor_f2'];}else if($r['stat_abs']=="DISPOSISI"){echo $rcekD['dabsor_f2'];}else{echo $r['absor_f2'];}?><?php } ?>
                                    <?php if($r['absor_f1']!="" or $rcekR['rabsor_f1']!=""){?>&#13;&#10;Back= <?php if($r['stat_abs']=="RANDOM"){echo $rcekR['rabsor_f1'];}else if($r['stat_abs']=="DISPOSISI"){echo $rcekD['dabsor_f1'];}else{echo $r['absor_f1'];}?><?php } ?>
                                    &#13;&#10;Afterwash :<?php if($r['absor_b2']!="" or $rcekR['rabsor_b2']!=""){?>&#13;&#10;Face= <?php if($r['stat_abs']=="RANDOM"){echo $rcekR['rabsor_b2'];}else if($r['stat_abs']=="DISPOSISI"){echo $rcekD['dabsor_b2'];}else{echo $r['absor_b2'];}?><?php } ?>
                                    <?php if($r['absor_b1']!="" or $rcekR['rabsor_b1']!=""){?>&#13;&#10;Back= <?php if($r['stat_abs']=="RANDOM"){echo $rcekR['rabsor_b1'];}else if($r['stat_abs']=="DISPOSISI"){echo $rcekD['dabsor_b1'];}else{echo $r['absor_b1'];}?><?php } ?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="abs" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="abs" class="form-control" placeholder="" rows="5">Depends On RDY Label &#13;&#10;&ge; 3 sec Knits / &le; 5 sec Woven &#13;&#10;&le; 5 sec Seamless (Knits & Woven)</textarea>
                                </div>
                        </div>
		        </div>
