            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Bursting Strength</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder=""><?php if($r['stat_bs']=="RANDOM"){echo $rcekR['rbs_tru'];}else if($r['stat_bs']=="DISPOSISI"){echo $rcekD['dbs_tru'];}else{echo $r['bs_tru'];}?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="bs" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="bs" class="form-control" placeholder="" rows="7">Natural(>50%): &#13;&#10;220 g/m<sup>2</sup> or lower &ge; 130 kPa &#13;&#10;221 g/m<sup>2</sup> or above &ge; 170 kPa &#13;&#10;Synthetic(>50%): &#13;&#10;220 g/m<sup>2</sup> or lower &ge; 170 kPa &#13;&#10;221 g/m<sup>2</sup> or above &ge; 250 kPa &#13;&#10;Teamwear &ge; 450 kPa</textarea>
                                </div>
                        </div>
		        </div>
