				...
				<table id="lookup" class="table table-bordered table-hover table-striped" width="100%">
					...
					<tbody>
						<?php
                                ...
                                $sql = mysqli_query($con,"SELECT a.* FROM tbl_tq_nokk a INNER JOIN tbl_tq_test b ON a.id=b.id_nokk WHERE LENGTH(a.no_test) = 12 and a.nodemand!='' and (a.pelanggan like'%mizuno%' or a.buyer like'%mizuno%') ");
                                $no="1";
