            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Wicking</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder="" rows="3">Length :<?php if($r['wick_l1']!="" or $rcekR['rwick_l1']!=""){?>&#13;&#10;Before Wash= <?php if($r['stat_wic']=="RANDOM"){echo $rcekR['rwick_l1'];}else if($r['stat_wic']=="DISPOSISI"){echo $rcekD['dwick_l1'];}else{echo $r['wick_l1'];}?><?php } ?>
                                    <?php if($r['wick_l2']!="" or $rcekR['rwick_l2']!=""){?>&#13;&#10;After Wash= <?php if($r['stat_wic']=="RANDOM"){echo $rcekR['rwick_l2'];}else if($r['stat_wic']=="DISPOSISI"){echo $rcekD['dwick_l2'];}else{echo $r['wick_l2'];}?><?php } ?>
                                    &#13;&#10;Width :<?php if($r['wick_w1']!="" or $rcekR['rwick_w1']!=""){?>&#13;&#10;Before Wash= <?php if($r['stat_wic']=="RANDOM"){echo $rcekR['rwick_w1'];}else if($r['stat_wic']=="DISPOSISI"){echo $rcekD['dwick_w1'];}else{echo $r['wick_w1'];}?><?php } ?>
                                    <?php if($r['wick_w2']!="" or $rcekR['rwick_w2']!=""){?>&#13;&#10;After Wash= <?php if($r['stat_wic']=="RANDOM"){echo $rcekR['rwick_w2'];}else if($r['stat_wic']=="DISPOSISI"){echo $rcekD['dwick_w2'];}else{echo $r['wick_w2'];}?><?php } ?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="wic" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="wic" class="form-control" placeholder="" rows="5">Depends On RDY Label &#13;&#10;&ge; 100 mm Knits (incl. Seamless) &#13;&#10;&ge; 90 mm Woven_[mm/30min]</textarea>
                                </div>
                        </div>
		        </div>
