	 	...
	 	<div class="col-md-6">
                  ...
                  <label for="no_po" class="col-sm-3 control-label">No Demand</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='TestingNew-'+this.value"  placeholder="No Demand" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
					</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					...
					onchange="window.location='TestingNewNoTes-'+this.value"  >
				</div>	
...
WHERE IF(a.`nodemand_new` != '', a.`nodemand_new`, a.`nodemand`) =  '$nodemand' 
-- or b.nodemand = '$nodemand'
ORDER BY a.id DESC LIMIT 1");
$cek=mysqli_num_rows($sqlCek);


if ($cek==0) {
	$sqlCek=mysqli_query($con,"SELECT b.*
	FROM tbl_tq_nokk_demand a 
	 	...
	 	<div class="col-md-6">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
						<?php foreach ($array_no_demand_other3_4 as $data_other)  { ?>
							<div style="border:solid thin #ddd; float:left; margin-left:10px;padding:5px "><?=$data_other?></div>
						<?php }?>	 		
				</div>
			</div>
	        <div class="form-group">
	  	...
	  	<div class="col-md-6">
			...
			<div class="form-group">
					...
					<div class="col-sm-5">
						<input name="lot_legacy" type="text" class="form-control" id="lot_legacy" placeholder="No Lot Legacy"
						value="<?php if($cek>0){echo $rcek['lot_legacy'];} ?>" readonly="readonly" >
					</div>
                </div>
		  	<div class="form-group">
                <label for="suhu" class="col-sm-3 control-label">Suhu</label>
					...
					<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
						...
						<div class="form-group" id="fc7" style="display:none;">
							...
							<div class="col-sm-1">
								...
								<input style="margin-top:15px" name="spirality1" type="text" class="form-control" id="spirality1" value="<?php echo $rcek1['spirality1'];?>" placeholder="SPI 1">
							</div>
							<div class="col-sm-1">
								...
								<input style="margin-top:15px" name="spirality2" type="text" class="form-control" id="spirality2" value="<?php echo $rcek1['spirality2'];?>" placeholder="SPI 2">
							</div>
							<div class="col-sm-1">
								...
								<input style="margin-top:15px" name="spirality3" type="text" class="form-control" id="spirality3" value="<?php echo $rcek1['spirality3'];?>" placeholder="SPI 3">
							</div>
							<div class="col-sm-1">
								...
								<input style="margin-top:15px" name="spirality4" type="text" class="form-control" id="spirality4" value="<?php echo $rcek1['spirality4'];?>" placeholder="SPI 4">
							</div>
							<div class="col-sm-1">
								...
								<input style="margin-top:15px"  name="spirality5" type="text" class="form-control" id="spirality5" value="<?php echo $rcek1['spirality5'];?>" placeholder="SPI 5">
							</div>
							<div class="col-sm-1">
								...
								<input style="margin-top:15px" name="spirality6" type="text" class="form-control" id="spirality6" value="<?php echo $rcek1['spirality6'];?>" placeholder="SPI 6">
							</div>
							<div class="col-sm-1">
								<textarea style="margin-bottom:10px" class="form-control" placeholder="Note harus diakhir tanda titik" name="sns_note" maxlength="50" rows="3"><?php echo $rcek1['sns_note'];?></textarea>
...
<section class="invoice">
      ...
      <div class="row invoice-info">
		...
		<tr>
		    ...
		    <td colspan="2"><?=$sco_acid_original[1] ?></td>
			<td><?=$sco_acid_original[2] ?></td>
		    <td colspan="2"> </td>
          	<td>&nbsp;</td>
        </tr>
		<tr>
		    ...
		    <td colspan="2"><?=$sca_acid_original[1]?></td>
			<td><?=$sca_acid_original[2]?></td>
		    <td colspan="2"></td>
          	<td>&nbsp;</td>
        </tr>
		<tr>
		    ...
		    <td colspan="2"><?=$sco_alkaline_afterwash[1]?></td>
			<td><?=$sco_alkaline_afterwash[2]?></td>
		    <td colspan="2"></td>
          	<td>&nbsp;</td>
        </tr>
		<tr>
		    ...
		    <td colspan="2"><?=$sca_alkaline_afterwash[1]?></td>
			<td><?=$sca_alkaline_afterwash[2]?></td>
		    <td colspan="2"></td>
          	<td>&nbsp;</td>
        </tr>
		<?php 
