            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Phenolic Yellowing</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder=""><?php if($r['stat_py']=="RANDOM"){echo $rcekR['rphenolic_colorchange'];}else if($r['stat_py']=="DISPOSISI"){echo $rcekD['dphenolic_colorchange'];}else{echo $r['phenolic_colorchange'];}?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="py" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="py" class="form-control" placeholder="">4-5 Color Change</textarea>
                                </div>
                        </div>
		        </div>
