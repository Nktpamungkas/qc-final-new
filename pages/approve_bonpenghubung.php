...
echo $row_actual_delivery['ACTUAL_DELIVERY'];?></td>	 
        <td>
          <?php if(($_SESSION['usrid'] == 'ppc') || ($_SESSION['usrid'] == 'marketing') || ($_SESSION['dept'] == 'QC')) { ?>
            <button class="button btn-success" onclick="window.location.href='pages/cetak/test.php'" target="_blank">ACTION</button>
          <?php } ?>
        </td>
