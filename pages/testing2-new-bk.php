...
$notes=$_GET['no_test'];
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE nodemand='$nodemand' AND no_test='$notes'");
      			...
      			<div class="form-group">
                  	...
                  	<div class="col-sm-4">
				  		<div class="input-group">	  
                     		...
                     		onchange="window.location='Testing2New-'+this.value" value="<?php echo $_GET['nodemand'];?>" placeholder="No Demand" required readonly>
					  	</div>	  
		  			</div>
					<!-- <?php if($cek>0){?><a href="#" class="btn btn-info btn-xs posisi_kktq" id="<?php echo $_GET['nodemand']; ?>">Posisi Terakhir</a><?php }?> -->
                </div>
				<div class="form-group">
					...
					<div class="col-sm-4">
						...
						value="<?php if($cek>0){echo $rcek['nokk'];} ?>" readonly>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="tab-pane active" id="tab_1">
						<form class="form-horizontal" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
							...
							<div class="form-group" id="fc7" style="display:none;">
								...
								<div class="col-sm-1">
									<label><input type="checkbox" name="ss_washes" id="ss_washes" class="minimal" value="3" <?php if($rcek1['ss_washes']=='3'){echo "checked";}?>> X3 &nbsp; &nbsp; &nbsp; &nbsp;
									</label>
									<label><input type="checkbox" name="ss_washes" id="ss_washes" class="minimal" value="10" <?php if($rcek1['ss_washes']=='10'){echo "checked";}?>> X10
									</label>
									<label><input type="checkbox" name="ss_washes" id="ss_washes" class="minimal" value="15" <?php if($rcek1['ss_washes']=='15'){echo "checked";}?>> X15
									</label>
								</div>
								<div class="col-sm-1">
							...
							<div class="form-group" id="dis_ss" style="display:none;">
								...
								<div class="col-sm-1">
									<label><input type="checkbox" name="dss_washes" id="dss_washes" class="minimal" value="3" <?php if($rcekD['dss_washes']=='3'){echo "checked";}?>> X3 &nbsp; &nbsp; &nbsp; &nbsp;
									</label>
									<label><input type="checkbox" name="dss_washes" id="dss_washes" class="minimal" value="10" <?php if($rcekD['dss_washes']=='10'){echo "checked";}?>> X10
									</label>
									<label><input type="checkbox" name="dss_washes" id="dss_washes" class="minimal" value="15" <?php if($rcekD['dss_washes']=='15'){echo "checked";}?>> X15
									</label>
								</div>
								<div class="col-sm-1">
							...
							<div class="form-group" id="mar_ss" style="display:none;">
								...
								<div class="col-sm-1">
									<label><input type="checkbox" name="mss_washes" id="mss_washes" class="minimal" value="3" <?php if($rcekM['mss_washes']=='3'){echo "checked";}?>> X3 &nbsp; &nbsp; &nbsp; &nbsp;
									</label>
									<label><input type="checkbox" name="mss_washes" id="mss_washes" class="minimal" value="10" <?php if($rcekM['mss_washes']=='10'){echo "checked";}?>> X10
									</label>
									<label><input type="checkbox" name="mss_washes" id="mss_washes" class="minimal" value="15" <?php if($rcekM['mss_washes']=='15'){echo "checked";}?>> X15
									</label>
								</div>
								<div class="col-sm-1">
							...
							<div class="form-group" id="ranss" style="display:none;">
								...
								<div class="col-sm-1">
									<label><input type="checkbox" name="rss_washes" id="rss_washes" class="minimal" value="3" <?php if($rcekR['rss_washes']=='3'){echo "checked";}?>> X3 &nbsp; &nbsp; &nbsp; &nbsp;
									</label>
									<label><input type="checkbox" name="rss_washes" id="rss_washes" class="minimal" value="10" <?php if($rcekR['rss_washes']=='10'){echo "checked";}?>> X10
									</label>
									<label><input type="checkbox" name="rss_washes" id="rss_washes" class="minimal" value="15" <?php if($rcekR['rss_washes']=='15'){echo "checked";}?>> X15
									</label>
								</div>
								<div class="col-sm-1">
...
`tgl_update`=now()");
		...
		if (result.value) {
			...
			window.location.href='Testing2New-$nodemand-$notes'; 
		}
		});</script>";
	 }
