...
//$mail->addCC('admin@usmanas.web.id');
//$mail->addBCC('usmanas.as@gmail.com');

// Subjek email
$mail->Subject = 'Tes QCF';
...
$mailContent ='
Dear Usman,<br>
Dibawah ini contoh tabel:<br>
<table border="1">
<tr>
	<td>No</td><td>Tanggal</td><td>No Order</td><td>Lot/td>
</tr>
<tr>
	...
	<div class="form-group">
	  ...
	  <div class="form-group">
		  ...
		  <div class="form-group">
                  ...
                  <div class="col-sm-8">
				  <textarea name="masalah" class="form-control" id="masalah" placeholder="Masalah"></textarea>  
                  </div>				   
          </div>
            ...
            <div class="modal-dialog" style="width: 80%;">
              ...
              <div class="form-group">
                    <textarea id="editor1" name="editor1" rows="10" cols="80">
                    	...
                    	<table border="1">
                    		<tr>
                    			<td>Tes</td><td>Tes</td><td>Tes</td><td>Tes</td>
                    		</tr>
                    		<tr>
                    			<td>Tes</td><td>Tes</td><td>Tes</td><td>Tes</td>
                    		</tr>
