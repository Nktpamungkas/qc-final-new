        ...
        <table class="table table-bordered table-hover table-striped nowrap" id="example3" style="width:100%">
          <thead class="bg-blue">
            <tr>
              ...
              <th><div align="center">Production Order</div></th>
          ...
          <?php
            ...
            if($tgl_awal!="" or $Order!="" or $PO!="" or $ArticleGrup!="" or $ArticleCode!="" or $Warna!="" or $Prodorder!="" or $Pelanggan!=""){
              ...
              SALESDOCUMENTLINE.SUBCODE02 = ITXVIEWCOLOR.SUBCODE02 AND 
              SALESDOCUMENTLINE.SUBCODE03 = ITXVIEWCOLOR.SUBCODE03 AND 
              SALESDOCUMENTLINE.SUBCODE04 = ITXVIEWCOLOR.SUBCODE04 AND
              SALESDOCUMENTLINE.SUBCODE05 = ITXVIEWCOLOR.SUBCODE05 AND
              SALESDOCUMENTLINE.SUBCODE06 = ITXVIEWCOLOR.SUBCODE06 AND
              SALESDOCUMENTLINE.SUBCODE07 = ITXVIEWCOLOR.SUBCODE07 AND
          ...
          <tr bgcolor="<?php echo $bgcolor; ?>">
            ...
            <td align="center"><?php echo number_format($row1['YARD'], 2)?></td>
