            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Water Reppelent</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder="" rows="3"><?php if($r['repp1']!="" or $rcekR['rrepp1']!=""){?>Original= <?php if($r['stat_wp']=="RANDOM"){echo $rcekR['rrepp1'];}else if($r['stat_wp']=="DISPOSISI"){echo $rcekD['drepp1'];}else{echo $r['repp1'];}?><?php } ?>
                                    <?php if($r['repp2']!="" or $rcekR['rrepp2']!=""){?>&#13;&#10;After Wash= <?php if($r['stat_wp']=="RANDOM"){echo $rcekR['rrepp2'];}else if($r['stat_wp']=="DISPOSISI"){echo $rcekD['drepp2'];}else{echo $r['repp2'];}?><?php } ?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="wr" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="wr" class="form-control" placeholder="">&ge; 4</textarea>
                                </div>
                        </div>
		        </div>
