...
<div class="modal fade modal-3d-slit" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="col-md-2">	 <!-- row1 -->		
              <div class="form-group">
                <input class="form-control" placeholder="To:" name="untuk" value="" required>
              </div>
			</div>
			<div class="col-md-2">	 <!-- row1 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="To:" name="untuk1" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- row1 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="To:" name="untuk2" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- row1 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="To:" name="untuk3" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- row1 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="To:" name="untuk4" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- row1 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="To:" name="untuk5" value="">
              </div>
			</div>
			...
			<div class="col-md-2">	 <!-- col2 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Cc:" name="cc1" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- col2 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Cc:" name="cc2" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- col2 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Cc:" name="cc3" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- col2 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Cc:" name="cc4" value="">
              </div>
			</div>
			<div class="col-md-2">	 <!-- col2 -->		
              <div class="form-group">
                <input type="text" class="form-control" placeholder="Cc:" name="cc5" value="">
              </div>
			</div>
			...
			<div class="form-group">			
				<div class="checkbox">
                      <label>
                        <input type="checkbox" value="1" name="ckqc" checked> Dept QC
                      </label>&nbsp;&nbsp;&nbsp;
            	      <label>
...
$mail->addAddress($_POST['untuk1']);
$mail->addAddress($_POST['untuk2']);
$mail->addAddress($_POST['untuk3']);
$mail->addAddress($_POST['untuk4']);
$mail->addAddress($_POST['untuk5']);	
...
$mail->addCC($_POST['cc']);
$mail->addCC($_POST['cc1']);
$mail->addCC($_POST['cc2']);
$mail->addCC($_POST['cc3']);
$mail->addCC($_POST['cc4']);
$mail->addCC($_POST['cc5']);
if($_POST['ckqc']=="1"){
	$mail->addCC('qcf@indotaichen.com');
