...
<div class="box box-success">
   	<div class="box-header with-border">
		...
		<div class="box-tools pull-right">
			...
			<?php 
				$fl_sql  =mysqli_query($con,"select id from tbl_tq_first_lot  where nodemand  = '$nodemand' order by id desc limit 1");
				$fl_data =mysqli_fetch_array($fl_sql);
				if ($fl_data) { ?>	
					<!--
...
<?php if (isset($_POST['update_first_lot'])) { ?>
	...
	$sqlCekNew = mysqli_query($con, "SELECT a.* 
			...
			WHERE b.nodemand = '$nodemand' order by b.id desc limit 1 ");
	$rcekNew = mysqli_fetch_array($sqlCekNew);
