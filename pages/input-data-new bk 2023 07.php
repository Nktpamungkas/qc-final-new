...
// $sqljp="SELECT SUBSTR(ELEMENTSINSPECTION.INSPECTIONSTARTDATETIME,12,5) AS JAM_PACKING FROM ELEMENTSINSPECTION ELEMENTSINSPECTION
// WHERE ELEMENTSINSPECTION.DEMANDCODE ='$nodemand' AND LENGTH(TRIM(ELEMENTSINSPECTION.ELEMENTCODE))=13 LIMIT 1";
// $stmt1=db2_exec($conn1,$sqljp, array('cursor'=>DB2_SCROLLABLE));
// $rowjp = db2_fetch_assoc($stmt1);
 ...
 <div class="box box-info">
  ...
  <div class="box-body"> 
	 <div class="col-md-6"> 
	  ...
	  <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    ...
                    value="<?php if($cek>0){echo $rcek['lebar_fin'];}else{echo $vallebar;}?>" placeholder="0" required>
                  </div>
				  <div class="col-sm-2">
                    <input name="fingrms" type="text" class="form-control" id="fingrms" 
                    value="<?php if($cek>0){echo $rcek['gramasi_fin'];}else{echo $valgramasi;}?>" placeholder="0" required>
                  </div>		
                </div>
	<div class="form-group">
                  ...
                  <div class="col-sm-2">
                    ...
                    value="<?php if($cek>0){echo $rcek['lebar_ins'];}else{echo $vallebar;}?>" placeholder="0" required>
                  </div>
				  <div class="col-sm-2">
                    <input name="insgrms" type="text" class="form-control" id="insgrms" 
                    value="<?php if($cek>0){echo $rcek['gramasi_ins'];}else{echo $valgramasi;}?>" placeholder="0" required>
                  </div>		
                </div>	  
	  <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="input-group date">
            ...
            <input name="tglfin" type="text" class="form-control pull-right" id="datepicker" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['tgl_fin'];}else{echo $rowdb2['TGL_FIN'];}?>" required/>
          </div>
        </div>
      </div>
	  <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="input-group date">
            <div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
            <input name="tglins" type="text" class="form-control pull-right" id="datepicker1" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['tgl_ins'];}else{echo $rowdb2['TGL_INS'];} ?>" />
          </div>
        </div>
	  </div>
	  <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="input-group date">
            <div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
            <input name="tglcwarna" type="text" class="form-control pull-right" id="datepicker4" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['tglcwarna'];}else{echo $rowdb2['TGL_CCK_WARNA'];}?>" required/>
          </div>
        </div>
		<div class="col-sm-2">
		...
		if (time.match(/^\d{2}$/) !== null) {
			...
			this.value = time + '';
		}" value="<?php if($cek>0){echo $rcek['jam_cwarna'];}else{echo SUBSTR($rowdb2['JAM_CCK_WARNA'],0,5);}?>" required size="5" maxlength="5"/>
        </div>
		<font color="red">
		<?php
	  ...
	  <div class="form-group">
        ...
        <div class="col-sm-4">
          <div class="input-group date">
            <div class="input-group-addon"> <i class="fa fa-calendar"></i> </div>
            <input name="tglpk" type="text" class="form-control pull-right" id="datepicker2" placeholder="0000-00-00" value="<?php if($cek>0){echo $rcek['tgl_pack'];}else{echo $rowdb2['TGL_PACK'];}?>" required/>
          </div>
        </div>
		<div class="col-sm-2">
		...
		if (time.match(/^\d{2}$/) !== null) {
			...
			this.value = time + '';
		}" value="<?php if($cek>0){echo $rcek['jam_pack'];}else{echo SUBSTR($rowdb2['JAM_PACK'],0,5);}?>" required size="5" maxlength="5"/>
        </div>
      </div>
	  <div class="form-group">
   ...
   <?php } ?>				   
		  ...
		  <input type="hidden" value="<?php if($cek>0){echo $rcek['pelanggan'];}else{echo $rowdb2['LEGALNAME1']."/".$rowdb2['BUYER'];}?>" name="pelanggan">
