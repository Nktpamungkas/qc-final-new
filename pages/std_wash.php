            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Washing Fastness</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder="" rows="10"><?php if($r['wash_temp']!="" or $rcekR['rwash_temp']!=""){?>Suhu= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_temp'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_temp'];}else{echo $r['wash_temp'];}?>&deg;C<?php } ?>
                                    <?php if($r['wash_colorchange']!="" or $rcekR['rwash_colorchange']!=""){?>&#13;&#10;Color Change= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_colorchange'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_colorchange'];}else{echo $r['wash_colorchange'];}?><?php } ?>
                                    <?php if($r['wash_acetate']!="" or $rcekR['rwash_acetate']!=""){?>&#13;&#10;Acetate= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_acetate'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_acetate'];}else{echo $r['wash_acetate'];}?><?php } ?>
                                    <?php if($r['wash_cotton']!="" or $rcekR['rwash_cotton']!=""){?>&#13;&#10;Cotton= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_cotton'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_cotton'];}else{echo $r['wash_cotton'];}?><?php } ?>
                                    <?php if($r['wash_nylon']!="" or $rcekR['rwash_nylon']!=""){?>&#13;&#10;Nylon= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_nylon'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_nylon'];}else{echo $r['wash_nylon'];}?><?php } ?>
                                    <?php if($r['wash_poly']!="" or $rcekR['rwash_poly']!=""){?>&#13;&#10;Polyester= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_poly'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_poly'];}else{echo $r['wash_poly'];}?><?php } ?>
                                    <?php if($r['wash_acrylic']!="" or $rcekR['rwash_acrylic']!=""){?>&#13;&#10;Acrylic= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_acrylic'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_acrylic'];}else{echo $r['wash_acrylic'];}?><?php } ?>
                                    <?php if($r['wash_wool']!="" or $rcekR['rwash_wool']!=""){?>&#13;&#10;Wool= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_wool'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_wool'];}else{echo $r['wash_wool'];}?><?php } ?>
                                    <?php if($r['wash_staining']!="" or $rcekR['rwash_staining']!=""){?>&#13;&#10;Staining= <?php if($r['stat_wf']=="RANDOM"){echo $rcekR['rwash_staining'];}else if($r['stat_wf']=="DISPOSISI"){echo $rcekD['dwash_staining'];}else{echo $r['wash_staining'];}?><?php } ?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="wash" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="wash" class="form-control" placeholder="" rows="8">4-5 Color Change &#13;&#10;4 Acetate &#13;&#10;4 Cotton &#13;&#10;4 Nylon &#13;&#10;4 Polyester &#13;&#10;4 Acrylic &#13;&#10;4 Wool &#13;&#10;4-5 Color Staining
                                    </textarea>
                                </div>
                        </div>
		        </div>
