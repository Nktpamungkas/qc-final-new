            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Ball Burst</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder=""><?php if($r['stat_bs2']=="RANDOM"){echo $rcekR['rbs_instron'];}else if($r['stat_bs2']=="DISPOSISI"){echo $rcekD['dbs_instron'];}else{echo $r['bs_instron'];}?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="bb" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="bb" class="form-control" placeholder="" rows="4">&ge; 200 N (Initial Requirement Only!) &#13;&#10;Teamwear/American Football : &ge; 700N &#13;&#10;Basketball/ Ice Hockey / Soccer/Football: &ge; 400N</textarea>
                                </div>
                        </div>
		        </div>
