...
?>
          <div class="modal-dialog">
            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="EditSTSGK" enctype="multipart/form-data">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Edit Status Ganti Kain</h4>
              </div>
              <div class="modal-body">
                <input type="hidden" id="id" name="id" value="<?php echo $r['id'];?>">
                    ...
                    <div class="form-group">
                            <label for="no_ordernew" class="col-sm-3 control-label">Bon Order Baru</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="no_ordernew" value="<?php echo $r['no_ordernew']; ?>">
                        </div> 
                    </div>
                    <div class="form-group">
