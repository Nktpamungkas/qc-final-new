            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Light Fastness</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder="" rows="3"><?php if($r['light_rating1']!="" or $rcekR['rlight_rating1']!=""){?>Rating 1= <?php if($r['stat_lg']=="RANDOM"){echo $rcekR['rlight_rating1'];}else if($r['stat_lg']=="DISPOSISI"){echo $rcekD['dlight_rating1'];}else{echo $r['light_rating1'];}?><?php } ?>
                                    <?php if($r['light_rating2']!="" or $rcekR['rlight_rating2']!=""){?>&#13;&#10;Rating 2= <?php if($r['stat_lg']=="RANDOM"){echo $rcekR['rlight_rating2'];}else if($r['stat_lg']=="DISPOSISI"){echo $rcekD['dlight_rating2'];}else{echo $r['light_rating2'];}?><?php } ?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="lf" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="lf" class="form-control" placeholder="" rows="5">3 Color Change (rating 1) &#13;&#10;&ge; 3 &#13;&#10;4 Color Change (rating 2) &#13;&#10;Dark colours : &ge; 4 &#13;&#10;Light colours : &ge; 3-4</textarea>
                                </div>
                        </div>
		        </div>
