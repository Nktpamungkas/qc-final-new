            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Fabric Weight</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder=""><?php if($r['stat_fwss2']=="RANDOM"){echo $rcekR['rf_weight'];}else if($r['stat_fwss2']=="DISPOSISI"){echo $rcekD['df_weight'];}else{echo $r['f_weight'];}?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="fwe" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="fwe" class="form-control" placeholder="">Difference +/-5%</textarea>
                                </div>
                        </div>
		        </div>
