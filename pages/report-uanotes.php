...
$rowdb2 = db2_fetch_assoc($stmt);
		function autono_report($notest)
		{
			include"koneksi.php";
				...
				//$no2 ="SLFT".$today.$Nold.$Urutd; 16 nov 23
				$no2 ="SLFT".$notest;
	 	...
	 	<div class="col-md-6">
                  ...
                  <label for="no_po" class="col-sm-3 control-label">No Demand</label>
                  	<div class="col-sm-4">
						<div class="input-group">	  
							...
							onchange="window.location='ReportUA-'+this.value" value="<?php if($rcek['nodemand_new']!=''){echo $rcek['nodemand_new'];}else if($rcek['nodemand_new']==''){echo $rcek['nodemand'];}else{echo $_GET['nodemand'];} ?>" placeholder="No KK" required <?php if($_SESSION['lvl_id']=="TQ"){echo "readonly";}?>>
						</div>	  
		  			</div>
            </div>
            ...
            <div class="form-group">
				...
				<input name="no_rptua" type="text" class="form-control" id="no_rptua" placeholder="Report No" readonly
                    value="<?php if($notes!="" AND ($rcek['no_rptua']=="" OR $rcek['no_rptua']==NULL)){echo autono_report($rcek['no_test']); }else if($notes!="" AND $rcek['no_rptua']!=""){echo 'INDO-'.$rcek['season'].$uaproduct.$rcek['no_hanger'].'-'.$rcek['warna'].'-'.$rcek['no_rptua'];}else{echo $ReportUA;} ?>">
