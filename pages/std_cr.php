            ...
            <form class="form-horizontal" name="modal_popup" data-toggle="validator" method="post" action="" enctype="multipart/form-data">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <h4 class="modal-title">Standard Crocking</h4>
                </div>
                <div class="modal-body">
                        <div class="form-group">
                            <label for="hasil_test" class="col-md-2 control-label">Hasil Test</label>
                                <div class="col-md-8">
                                    <textarea name="hasil_test" class="form-control" placeholder="" rows="5">Length :<?php if($r['crock_len1']!="" or $rcekR['rcrock_len1']!=""){?>&#13;&#10;Dry= <?php if($r['stat_cr']=="RANDOM"){echo $rcekR['rcrock_len1'];}else if($r['stat_cr']=="DISPOSISI"){echo $rcekD['dcrock_len1'];}else{echo $r['crock_len1'];}?><?php } ?>
                                    <?php if($r['crock_len2']!="" or $rcekR['rcrock_len2']!=""){?>&#13;&#10;Wet= <?php if($r['stat_cr']=="RANDOM"){echo $rcekR['rcrock_len2'];}else if($r['stat_cr']=="DISPOSISI"){echo $rcekD['dcrock_len2'];}else{echo $r['crock_len2'];}?><?php } ?>
                                    &#13;&#10;Width :<?php if($r['crock_wid1']!="" or $rcekR['rcrock_wid1']!=""){?>&#13;&#10;Dry= <?php if($r['stat_cr']=="RANDOM"){echo $rcekR['rcrock_wid1'];}else if($r['stat_cr']=="DISPOSISI"){echo $rcekD['dcrock_wid1'];}else{echo $r['crock_wid1'];}?><?php } ?>
                                    <?php if($r['crock_wid2']!="" or $rcekR['rcrock_wid2']!=""){?>&#13;&#10;Wet= <?php if($r['stat_cr']=="RANDOM"){echo $rcekR['rcrock_wid2'];}else if($r['stat_cr']=="DISPOSISI"){echo $rcekD['dcrock_wid2'];}else{echo $r['crock_wid2'];}?><?php } ?>
                                    </textarea>
                                </div>
                        </div>
                        <div class="form-group">
                            <label for="cr" class="col-md-2 control-label">Standard</label>
                                <div class="col-md-8">
                                    <textarea name="cr" class="form-control" placeholder="">4 Dry &#13;&#10;3 Wet</textarea>
                                </div>
                        </div>
		        </div>
