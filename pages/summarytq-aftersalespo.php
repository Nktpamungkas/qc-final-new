...
$qry=mysqli_query($con,"SELECT a.*, a.id AS idkk, b.* From tbl_tq_nokk a INNER JOIN tbl_master_test b ON a.no_test=b.no_testmaster WHERE no_po='$PO' and no_test='$Notest'");
    ...
    <div class="box-body"> 
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="no_po" type="text" class="form-control" id="no_po" placeholder="No PO" value="<?php echo $_GET['no_po'];?>" onchange="window.location='index1.php?p=summarytq-aftersalespo&amp;no_po='+this.value">
                </div>				   
            </div>
            <div class="form-group">
                <label for="no_test" class="col-sm-3 control-label">No Test</label>
                <div class="col-sm-4">
                    <select name="no_test" id="no_test" class="form-control select2">
                    <?php if($PO!=""){?>
                    <?php $qryNoTes=mysqli_query($con,"SELECT no_test FROM tbl_tq_nokk WHERE no_po='$PO' ORDER BY no_test DESC");
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input name="no_order" type="text" class="form-control" id="no_order" placeholder="No Order" value="<?php if($cekd>0){echo $rd['no_order'];}else {echo $_GET['no_order'];}?>" onchange="window.location='index1.php?p=summarytq-aftersales&amp;no_order='+this.value">
                </div>				   
            </div> 
            <div class="form-group">
...
if($_POST['status_save']=="save" and $_POST['status']==""){
  echo "<script>swal({
    ...
    if (result.value) {
     ...
     window.location.href='SummaryTQAftersalesPO-$PO'; 
    }
  });</script>";
...
if($no_test!="" and $cekd==0){
 ...
 if (result.value) {
    ...
    window.location.href='SummaryTQAftersalesPO'; 
 }
});</script>";
}
?>
