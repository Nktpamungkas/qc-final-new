...
$sqlCek=mysqli_query($con,"SELECT * FROM tbl_tq_nokk WHERE IF(`nodemand_new` != '', `nodemand_new`, `nodemand`) =  '$nodemand' OR IF(`nodemand_new` != '', `nodemand_new`, `nodemand`) =  '$nodemand_post' ORDER BY id DESC LIMIT 1");
