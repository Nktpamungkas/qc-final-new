...
$qry=mysqli_query($con,"SELECT a.*, a.id AS idkk, b.* From tbl_tq_nokk a INNER JOIN tbl_master_test b ON a.no_test=b.no_testmaster WHERE no_order='$Order' and no_test='$Notest'");
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <?php if($Order!=""){?>
                    <?php $qryNoTes=mysqli_query($con,"SELECT no_test FROM tbl_tq_nokk WHERE no_order='$Order' ORDER BY no_test DESC");
...
if($_POST['status_save']=="save" and $_POST['status']==""){
  echo "<script>swal({
    ...
    if (result.value) {
     ...
     window.location.href='SummaryTQAftersales-$Order'; 
    }
  });</script>";
...
if($no_test!="" and $cekd==0){
 ...
 if (result.value) {
    ...
    window.location.href='SummaryTQAftersales'; 
 }
});</script>";
}
?>
